; ModuleID = '/home/martin/projects/metasafe/trust/benchmarks/std/target/x86_64-unknown-linux-gnu/release/deps/rand-606668b8aeb2710e.bc'
source_filename = "rand.82xez9ab-cgu.0"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%"core::fmt::Formatter.253" = type { [0 x i64], { i64, i64 }, [0 x i64], { i64, i64 }, [0 x i64], { {}*, [3 x i64]* }, [0 x i32], i32, [0 x i32], i32, [0 x i8], i8, [7 x i8] }
%"std::thread::AccessError.254" = type { [0 x i8], {}, [0 x i8] }
%"std::io::Error.256" = type { [0 x i64], %"std::io::error::Repr.255", [0 x i64] }
%"std::io::error::Repr.255" = type { [0 x i8], i8, [15 x i8] }
%"distributions::uniform::UniformInt<u64>.257" = type { [0 x i64], i64, [0 x i64], i64, [0 x i64], i64, [0 x i64] }
%"distributions::uniform::UniformInt<u32>.258" = type { [0 x i32], i32, [0 x i32], i32, [0 x i32], i32, [0 x i32] }
%"distributions::uniform::UniformDurationMode.259" = type { [0 x i32], i32, [9 x i32] }
%"distributions::uniform::Uniform<u64>.260" = type { [0 x i64], %"distributions::uniform::UniformInt<u64>.257", [0 x i64] }
%"distributions::uniform::Uniform<u32>.261" = type { [0 x i32], %"distributions::uniform::UniformInt<u32>.258", [0 x i32] }
%"rand_chacha::ChaCha12Rng.267" = type { [0 x i64], %"rand_core::block::BlockRng<rand_chacha::ChaCha12Core>.266", [0 x i64] }
%"rand_core::block::BlockRng<rand_chacha::ChaCha12Core>.266" = type { [0 x i64], i64, [0 x i32], %"rand_chacha::chacha::Array64<u32>.262", [2 x i32], %"rand_chacha::ChaCha12Core.265", [0 x i64] }
%"rand_chacha::chacha::Array64<u32>.262" = type { [0 x i32], [64 x i32], [0 x i32] }
%"rand_chacha::ChaCha12Core.265" = type { [0 x i64], %"rand_chacha::guts::ChaCha.264", [0 x i64] }
%"rand_chacha::guts::ChaCha.264" = type { [0 x i64], %"ppv_lite86::x86_64::vec128_storage.263", [0 x i64], %"ppv_lite86::x86_64::vec128_storage.263", [0 x i64], %"ppv_lite86::x86_64::vec128_storage.263", [0 x i64] }
%"ppv_lite86::x86_64::vec128_storage.263" = type { [2 x i64] }
%"std::vec::Vec<usize>.268" = type { [0 x i64], { i64*, i64 }, [0 x i64], i64, [0 x i64] }
%"std::vec::Vec<u32>.269" = type { [0 x i64], { i32*, i64 }, [0 x i64], i64, [0 x i64] }
%"std::vec::IntoIter<usize>.271" = type { [0 x i8], %"core::marker::PhantomData<usize>.270", [0 x i8], i64*, [0 x i64], i64, [0 x i64], i64*, [0 x i64], i64*, [0 x i64] }
%"core::marker::PhantomData<usize>.270" = type {}
%"std::vec::IntoIter<u32>.273" = type { [0 x i8], %"core::marker::PhantomData<u32>.272", [0 x i8], i32*, [0 x i64], i64, [0 x i64], i32*, [0 x i64], i32*, [0 x i64] }
%"core::marker::PhantomData<u32>.272" = type {}
%"core::panic::Location.289" = type { [0 x i64], { [0 x i8]*, i64 }, [0 x i32], i32, [0 x i32], i32, [0 x i32] }
%"rand_core::OsRng.277" = type {}
%"std::sync::Once.294" = type { [0 x i8], %"core::marker::PhantomData<*const std::sync::once::Waiter>.292", [0 x i8], %"core::sync::atomic::AtomicUsize.293", [0 x i64] }
%"core::marker::PhantomData<*const std::sync::once::Waiter>.292" = type {}
%"core::sync::atomic::AtomicUsize.293" = type { [0 x i64], i64, [0 x i64] }
%"core::fmt::DebugList.296" = type { [0 x i64], %"core::fmt::builders::DebugInner.295", [0 x i64] }
%"core::fmt::builders::DebugInner.295" = type { [0 x i64], %"core::fmt::Formatter.253"*, [0 x i8], i8, [0 x i8], i8, [6 x i8] }
%"core::fmt::DebugStruct.299" = type { [0 x i64], %"core::fmt::Formatter.253"*, [0 x i8], i8, [0 x i8], i8, [6 x i8] }
%"core::fmt::DebugTuple.298" = type { [0 x i64], %"core::fmt::Formatter.253"*, [0 x i64], i64, [0 x i8], i8, [0 x i8], i8, [6 x i8] }
%"std::io::error::Custom.300" = type { [0 x i64], { {}*, [3 x i64]* }, [0 x i8], i8, [7 x i8] }
%"distributions::bernoulli::BernoulliError::InvalidProbability.274" = type {}
%"distributions::slice::EmptySlice.275" = type {}
%"core::fmt::Arguments.297" = type { [0 x i64], { [0 x { [0 x i8]*, i64 }]*, i64 }, [0 x i64], { i64*, i64 }, [0 x i64], { [0 x { i8*, i64* }]*, i64 }, [0 x i64] }
%"rngs::adapter::read::ReadError.276" = type { [0 x i64], %"std::io::Error.256", [0 x i64] }
%"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278" = type { [0 x i8], %"rand_core::OsRng.277", [0 x i8], %"rand_chacha::ChaCha12Core.265", [0 x i64], i64, [0 x i64], i64, [0 x i64], i64, [1 x i64] }
%"rand_core::block::BlockRng<rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>>.301" = type { [0 x i64], i64, [0 x i32], %"rand_chacha::chacha::Array64<u32>.262", [2 x i32], %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278", [0 x i64] }
%"seq::index::IndexVec.279" = type { [0 x i64], i64, [3 x i64] }
%"distributions::float::OpenClosed01.280" = type {}
%"distributions::float::Open01.281" = type {}
%"distributions::other::Alphanumeric.282" = type {}
%"distributions::uniform::UniformChar.283" = type { [0 x i32], %"distributions::uniform::UniformInt<u32>.258", [0 x i32] }
%"distributions::uniform::UniformDuration.284" = type { [0 x i64], %"distributions::uniform::UniformDurationMode.259", [0 x i32], i32, [1 x i32] }
%"distributions::Standard.285" = type {}
%"rngs::std::StdRng.286" = type { [0 x i64], %"rand_chacha::ChaCha12Rng.267", [0 x i64] }
%"seq::index::IndexVecIter.287" = type { [0 x i64], i64, [2 x i64] }
%"seq::index::IndexVecIntoIter.288" = type { [0 x i64], i64, [4 x i64] }
%"unwind::libunwind::_Unwind_Exception.290" = type { [0 x i64], i64, [0 x i64], void (i32, %"unwind::libunwind::_Unwind_Exception.290"*)*, [0 x i64], [6 x i64], [0 x i64] }
%"unwind::libunwind::_Unwind_Context.291" = type { [0 x i8] }

@METASAFE_TYPE_ID = external thread_local local_unnamed_addr global i64
@vtable.0 = private unnamed_addr constant { void (i8**)*, i64, i64, void (i8**, { i64, i8 }*)*, void (i8**, { i64, i8 }*)* } { void (i8**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (i8**)*), i64 8, i64 8, void (i8**, { i64, i8 }*)* @"_ZN3std4sync4once4Once9call_once28_$u7b$$u7b$closure$u7d$$u7d$17h64cf0f175cacfdadE", void (i8**, { i64, i8 }*)* @"_ZN4core3ops8function6FnOnce40call_once$u7b$$u7b$vtable.shim$u7d$$u7d$17h2c09827dcee458e5E" }, align 8
...
@vtable.1 = private unnamed_addr constant { void (i32**)*, i64, i64, i1 (i32**, %"core::fmt::Formatter.253"*)* } { void (i32**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (i32**)*), i64 8, i64 8, i1 (i32**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17heeec9cc1e9046680E" }, align 8
@vtable.2 = private unnamed_addr constant { void (i64**)*, i64, i64, i1 (i64**, %"core::fmt::Formatter.253"*)* } { void (i64**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (i64**)*), i64 8, i64 8, i1 (i64**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h9a670d4538304c2dE" }, align 8
@alloc1198 = private unnamed_addr constant <{ [43 x i8] }> <{ [43 x i8] c"called `Option::unwrap()` on a `None` value" }>, align 1
@vtable.3 = private unnamed_addr constant { void (%"std::thread::AccessError.254"*)*, i64, i64, i1 (%"std::thread::AccessError.254"*, %"core::fmt::Formatter.253"*)* } { void (%"std::thread::AccessError.254"*)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (%"std::thread::AccessError.254"*)*), i64 0, i64 1, i1 (%"std::thread::AccessError.254"*, %"core::fmt::Formatter.253"*)* @"_ZN68_$LT$std..thread..local..AccessError$u20$as$u20$core..fmt..Debug$GT$3fmt17ha315f601bcb7816fE" }, align 8
...
@vtable.4 = private unnamed_addr constant { void ({ [0 x i64]*, i64 }*)*, i64, i64, i1 ({ [0 x i64]*, i64 }*, %"core::fmt::Formatter.253"*)* } { void ({ [0 x i64]*, i64 }*)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void ({ [0 x i64]*, i64 }*)*), i64 16, i64 8, i1 ({ [0 x i64]*, i64 }*, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h156ca560897cf937E" }, align 8
@vtable.5 = private unnamed_addr constant { void ({ [0 x i32]*, i64 }*)*, i64, i64, i1 ({ [0 x i32]*, i64 }*, %"core::fmt::Formatter.253"*)* } { void ({ [0 x i32]*, i64 }*)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void ({ [0 x i32]*, i64 }*)*), i64 16, i64 8, i1 ({ [0 x i32]*, i64 }*, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17hbe11e245420fa081E" }, align 8
...
@vtable.6 = private unnamed_addr constant { void (%"std::io::Error.256"*)*, i64, i64, { i8*, i8* } (%"std::io::Error.256"*)*, i64 (%"std::io::Error.256"*)*, i64* (%"std::io::Error.256"*)*, { [0 x i8]*, i64 } (%"std::io::Error.256"*)*, { i8*, i8* } (%"std::io::Error.256"*)*, i1 (%"std::io::Error.256"*, %"core::fmt::Formatter.253"*)*, i1 (%"std::io::Error.256"*, %"core::fmt::Formatter.253"*)* } { void (%"std::io::Error.256"*)* @_ZN4core3ptr13drop_in_place17h5a43ebe0868d6058E, i64 16, i64 8, { i8*, i8* } (%"std::io::Error.256"*)* @"_ZN59_$LT$std..io..error..Error$u20$as$u20$std..error..Error$GT$6source17h58eb92854d84e79fE", i64 (%"std::io::Error.256"*)* @_ZN3std5error5Error7type_id17h8465ebaf1fb6fab3E, i64* (%"std::io::Error.256"*)* @_ZN3std5error5Error9backtrace17h2c946114f767c0adE, { [0 x i8]*, i64 } (%"std::io::Error.256"*)* @"_ZN59_$LT$std..io..error..Error$u20$as$u20$std..error..Error$GT$11description17hdc6ea995e10d5d20E", { i8*, i8* } (%"std::io::Error.256"*)* @"_ZN59_$LT$std..io..error..Error$u20$as$u20$std..error..Error$GT$5cause17h1043acf78dfb3752E", i1 (%"std::io::Error.256"*, %"core::fmt::Formatter.253"*)* @"_ZN60_$LT$std..io..error..Error$u20$as$u20$core..fmt..Display$GT$3fmt17ha444a7daee083529E", i1 (%"std::io::Error.256"*, %"core::fmt::Formatter.253"*)* @"_ZN58_$LT$std..io..error..Error$u20$as$u20$core..fmt..Debug$GT$3fmt17h92bc210ff9abc8b7E" }, align 8
...
@vtable.7 = private unnamed_addr constant { void (i64**)*, i64, i64, i1 (i64**, %"core::fmt::Formatter.253"*)* } { void (i64**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (i64**)*), i64 8, i64 8, i1 (i64**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h37ac390e8963fd9aE" }, align 8
...
@vtable.8 = private unnamed_addr constant { void (%"distributions::uniform::UniformInt<u64>.257"**)*, i64, i64, i1 (%"distributions::uniform::UniformInt<u64>.257"**, %"core::fmt::Formatter.253"*)* } { void (%"distributions::uniform::UniformInt<u64>.257"**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (%"distributions::uniform::UniformInt<u64>.257"**)*), i64 8, i64 8, i1 (%"distributions::uniform::UniformInt<u64>.257"**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h2c97e1bbf9bed3c2E" }, align 8
@vtable.9 = private unnamed_addr constant { void (%"distributions::uniform::UniformInt<u32>.258"**)*, i64, i64, i1 (%"distributions::uniform::UniformInt<u32>.258"**, %"core::fmt::Formatter.253"*)* } { void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E, i64 8, i64 8, i1 (%"distributions::uniform::UniformInt<u32>.258"**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h7f48b8fcb63839ccE" }, align 8
...
@vtable.a = private unnamed_addr constant { void (%"distributions::uniform::UniformDurationMode.259"**)*, i64, i64, i1 (%"distributions::uniform::UniformDurationMode.259"**, %"core::fmt::Formatter.253"*)* } { void (%"distributions::uniform::UniformDurationMode.259"**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (%"distributions::uniform::UniformDurationMode.259"**)*), i64 8, i64 8, i1 (%"distributions::uniform::UniformDurationMode.259"**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h1262f2a1905c1ff5E" }, align 8
...
@vtable.b = private unnamed_addr constant { void (%"distributions::uniform::Uniform<u64>.260"**)*, i64, i64, i1 (%"distributions::uniform::Uniform<u64>.260"**, %"core::fmt::Formatter.253"*)* } { void (%"distributions::uniform::Uniform<u64>.260"**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (%"distributions::uniform::Uniform<u64>.260"**)*), i64 8, i64 8, i1 (%"distributions::uniform::Uniform<u64>.260"**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h84688a13dd8aaddeE" }, align 8
...
@vtable.c = private unnamed_addr constant { void (%"distributions::uniform::Uniform<u32>.261"**)*, i64, i64, i1 (%"distributions::uniform::Uniform<u32>.261"**, %"core::fmt::Formatter.253"*)* } { void (%"distributions::uniform::Uniform<u32>.261"**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (%"distributions::uniform::Uniform<u32>.261"**)*), i64 8, i64 8, i1 (%"distributions::uniform::Uniform<u32>.261"**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17hc2ea958c0fbd8084E" }, align 8
...
@vtable.d = private unnamed_addr constant { void (%"std::io::Error.256"**)*, i64, i64, i1 (%"std::io::Error.256"**, %"core::fmt::Formatter.253"*)* } { void (%"std::io::Error.256"**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (%"std::io::Error.256"**)*), i64 8, i64 8, i1 (%"std::io::Error.256"**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17hbd0fb5f0e82e028fE" }, align 8
...
@vtable.e = private unnamed_addr constant { void (%"rand_chacha::ChaCha12Rng.267"**)*, i64, i64, i1 (%"rand_chacha::ChaCha12Rng.267"**, %"core::fmt::Formatter.253"*)* } { void (%"rand_chacha::ChaCha12Rng.267"**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (%"rand_chacha::ChaCha12Rng.267"**)*), i64 8, i64 8, i1 (%"rand_chacha::ChaCha12Rng.267"**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h134f43344a9663cbE" }, align 8
...
@vtable.f = private unnamed_addr constant { void (i64***)*, i64, i64, i1 (i64***, %"core::fmt::Formatter.253"*)* } { void (i64***)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (i64***)*), i64 8, i64 8, i1 (i64***, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h003e111bb83a4b8bE" }, align 8
...
@vtable.g = private unnamed_addr constant { void (%"std::vec::Vec<usize>.268"**)*, i64, i64, i1 (%"std::vec::Vec<usize>.268"**, %"core::fmt::Formatter.253"*)* } { void (%"std::vec::Vec<usize>.268"**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (%"std::vec::Vec<usize>.268"**)*), i64 8, i64 8, i1 (%"std::vec::Vec<usize>.268"**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h1051f4193bf50a69E" }, align 8
@alloc1270 = private unnamed_addr constant <{ [3 x i8] }> <{ [3 x i8] c"U32" }>, align 1
@vtable.h = private unnamed_addr constant { void (%"std::vec::Vec<u32>.269"**)*, i64, i64, i1 (%"std::vec::Vec<u32>.269"**, %"core::fmt::Formatter.253"*)* } { void (%"std::vec::Vec<u32>.269"**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (%"std::vec::Vec<u32>.269"**)*), i64 8, i64 8, i1 (%"std::vec::Vec<u32>.269"**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17hd718dec522aaa46bE" }, align 8
@vtable.i = private unnamed_addr constant { void ({ i64*, i64* }**)*, i64, i64, i1 ({ i64*, i64* }**, %"core::fmt::Formatter.253"*)* } { void ({ i64*, i64* }**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void ({ i64*, i64* }**)*), i64 8, i64 8, i1 ({ i64*, i64* }**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h6f81b967e2d08741E" }, align 8
@vtable.j = private unnamed_addr constant { void ({ i32*, i32* }**)*, i64, i64, i1 ({ i32*, i32* }**, %"core::fmt::Formatter.253"*)* } { void ({ i32*, i32* }**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void ({ i32*, i32* }**)*), i64 8, i64 8, i1 ({ i32*, i32* }**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h99ebe484993ae679E" }, align 8
@vtable.k = private unnamed_addr constant { void (%"std::vec::IntoIter<usize>.271"**)*, i64, i64, i1 (%"std::vec::IntoIter<usize>.271"**, %"core::fmt::Formatter.253"*)* } { void (%"std::vec::IntoIter<usize>.271"**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (%"std::vec::IntoIter<usize>.271"**)*), i64 8, i64 8, i1 (%"std::vec::IntoIter<usize>.271"**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h65e48835fafcbe1cE" }, align 8
@vtable.l = private unnamed_addr constant { void (%"std::vec::IntoIter<u32>.273"**)*, i64, i64, i1 (%"std::vec::IntoIter<u32>.273"**, %"core::fmt::Formatter.253"*)* } { void (%"std::vec::IntoIter<u32>.273"**)* bitcast (void (%"distributions::uniform::UniformInt<u32>.258"**)* @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E to void (%"std::vec::IntoIter<u32>.273"**)*), i64 8, i64 8, i1 (%"std::vec::IntoIter<u32>.273"**, %"core::fmt::Formatter.253"*)* @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17hf67ad8a0bdc4010aE" }, align 8
...
define internal void @"_ZN3std4sync4once4Once9call_once28_$u7b$$u7b$closure$u7d$$u7d$17h64cf0f175cacfdadE"(i8** nocapture readonly align 8 dereferenceable(8) %_1, { i64, i8 }* mpk_immut nocapture readnone align 8 dereferenceable(16) %_2) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
start:
...
bb1.i:                                            ; preds = %start
  tail call void @_ZN4core9panicking5panic17hc14ab8d72efd34afE([0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [43 x i8] }>* @alloc1198 to [0 x i8]*), i64 43, %"core::panic::Location.289"* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast (<{ i8*, [16 x i8] }>* @alloc1180 to %"core::panic::Location.289"*))
  unreachable
...
define internal i64 @_ZN3std5error5Error7type_id17h8465ebaf1fb6fab3E(%"std::io::Error.256"* mpk_immut noalias nocapture readonly align 8 dereferenceable(16) %self) unnamed_addr #1 {
start:
  ret i64 8497881545150036703
}

; Function Attrs: norecurse nounwind nonlazybind readnone uwtable
define internal mpk_immut noalias align 8 dereferenceable_or_null(64) i64* @_ZN3std5error5Error9backtrace17h2c946114f767c0adE(%"std::io::Error.256"* mpk_immut noalias nocapture readonly align 8 dereferenceable(16) %self) unnamed_addr #1 {
start:
  ret i64* null
}

; Function Attrs: noinline nonlazybind uwtable
define internal fastcc mpk_immut align 8 dereferenceable_or_null(8) i64* @"_ZN3std6thread5local4fast12Key$LT$T$GT$14try_initialize17h6483af7d7c1a9d6dE"() unnamed_addr #2 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
start:
  %rng.i.i.i.i = alloca %"rand_core::OsRng.277", align 1
  %_12.i.i.i.i.i.i.i = alloca i8*, align 8
  %f.i.i.i.i.i.i.i = alloca i8, align 1
  %_6.sroa.0.i.sroa.4.i.i.i = alloca [40 x i8], align 8
  %_2.i.i.i.i.i = alloca %"rand_chacha::guts::ChaCha.264", align 16
...
bb8:                                              ; preds = %bb4.i, %start
  ...
  %4 = bitcast %"rand_core::OsRng.277"* %rng.i.i.i.i to i8*
  ...
  %6 = call { i8*, i8* } @"_ZN59_$LT$rand_core..os..OsRng$u20$as$u20$rand_core..RngCore$GT$14try_fill_bytes17hd80590ef176c258cE"(%"rand_core::OsRng.277"* nonnull align 1 %rng.i.i.i.i, [0 x i8]* nonnull align 1 %_5.0.i.i.i.i.i, i64 32), !noalias !5
...
"_ZN4core6result19Result$LT$T$C$E$GT$14unwrap_or_else17hd5daf006daeb8e28E.exit.i.i.i": ; preds = %bb8
  ...
  %11 = bitcast %"rand_chacha::guts::ChaCha.264"* %_2.i.i.i.i.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 48, i8* nonnull %11), !noalias !15
  call void @_ZN11rand_chacha4guts11init_chacha17h5a24505c0c6e62e9E(%"rand_chacha::guts::ChaCha.264"* noalias nocapture nonnull sret dereferenceable(48) %_2.i.i.i.i.i, [32 x i8]* mpk_immut noalias nonnull readonly align 1 dereferenceable(32) %_15.i.i.i.i, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [8 x i8] }>* @alloc992 to [0 x i8]*), i64 8), !noalias !5
  %_14.sroa.0.i.sroa.0.0..sroa_idx.i.i.i = getelementptr inbounds %"rand_chacha::guts::ChaCha.264", %"rand_chacha::guts::ChaCha.264"* %_2.i.i.i.i.i, i64 0, i32 0, i64 0
  %_14.sroa.0.i.sroa.0.0.copyload.i.i.i = load i64, i64* %_14.sroa.0.i.sroa.0.0..sroa_idx.i.i.i, align 16, !noalias !19
  %_14.sroa.0.i.sroa.4.0..sroa_idx.i.i.i = getelementptr inbounds %"rand_chacha::guts::ChaCha.264", %"rand_chacha::guts::ChaCha.264"* %_2.i.i.i.i.i, i64 0, i32 1, i32 0, i64 1
...
define internal void @_ZN3std6thread5local4fast13destroy_value17h243852371f15a28cE(i8* mpk_unsafe nocapture %ptr) unnamed_addr #3 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
bb2:
...
; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h003e111bb83a4b8bE"(i64*** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %0 = tail call zeroext i1 @_ZN4core3fmt9Formatter3pad17h77c5e3cc34c58830E(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [10 x i8] }>* @alloc1203 to [0 x i8]*), i64 10)
  ret i1 %0
}

; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h1051f4193bf50a69E"(%"std::vec::Vec<usize>.268"** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
start:
  %entry.i.i.i = alloca i64*, align 8
  %_6.i.i = alloca %"core::fmt::DebugList.296", align 8
  %_4 = load %"std::vec::Vec<usize>.268"*, %"std::vec::Vec<usize>.268"** %self, align 8, !nonnull !2
  %0 = bitcast %"std::vec::Vec<usize>.268"* %_4 to [0 x i64]**
  %_3.idx.val.i1.i.i = load [0 x i64]*, [0 x i64]** %0, align 8, !alias.scope !31, !nonnull !2
  %1 = getelementptr inbounds %"std::vec::Vec<usize>.268", %"std::vec::Vec<usize>.268"* %_4, i64 0, i32 3
  %_4.i.i = load i64, i64* %1, align 8, !alias.scope !38
  %2 = bitcast %"core::fmt::DebugList.296"* %_6.i.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %2), !noalias !39
  %3 = tail call i128 @_ZN4core3fmt9Formatter10debug_list17h8147fa4f8cb43178E(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f), !noalias !39
  %.0..sroa_cast.i.i = bitcast %"core::fmt::DebugList.296"* %_6.i.i to i128*
...
bb3.i.i.i:                                        ; preds = %bb3.i.i.i, %bb3.lr.ph.i.i.i
  ...
  %_15.i.i.i = call align 8 dereferenceable(16) %"core::fmt::DebugList.296"* @_ZN4core3fmt8builders9DebugList5entry17h65db77502f12805cE(%"core::fmt::DebugList.296"* nonnull align 8 dereferenceable(16) %_6.i.i, {}* mpk_immut nonnull align 1 %_17.0.i.i.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i64**)*, i64, i64, i1 (i64**, %"core::fmt::Formatter.253"*)* }* @vtable.2 to [3 x i64]*)), !noalias !42
...
"_ZN61_$LT$alloc..vec..Vec$LT$T$GT$$u20$as$u20$core..fmt..Debug$GT$3fmt17h05bc364cb8e060a4E.exit": ; preds = %bb3.i.i.i, %start
  %8 = call zeroext i1 @_ZN4core3fmt8builders9DebugList6finish17h1110a7134d6ce275E(%"core::fmt::DebugList.296"* nonnull align 8 dereferenceable(16) %_6.i.i), !noalias !42
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %2), !noalias !39
  ret i1 %8
}

; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h1262f2a1905c1ff5E"(%"distributions::uniform::UniformDurationMode.259"** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_4 = load %"distributions::uniform::UniformDurationMode.259"*, %"distributions::uniform::UniformDurationMode.259"** %self, align 8, !nonnull !2
  %0 = tail call zeroext i1 @"_ZN86_$LT$rand..distributions..uniform..UniformDurationMode$u20$as$u20$core..fmt..Debug$GT$3fmt17h35ec28cf3936b898E"(%"distributions::uniform::UniformDurationMode.259"* mpk_immut noalias nonnull readonly align 8 dereferenceable(40) %_4, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f)
  ret i1 %0
}

; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h134f43344a9663cbE"(%"rand_chacha::ChaCha12Rng.267"** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_4 = load %"rand_chacha::ChaCha12Rng.267"*, %"rand_chacha::ChaCha12Rng.267"** %self, align 8, !nonnull !2
  %0 = tail call zeroext i1 @"_ZN69_$LT$rand_chacha..chacha..ChaCha12Rng$u20$as$u20$core..fmt..Debug$GT$3fmt17h0c2da16597097293E"(%"rand_chacha::ChaCha12Rng.267"* mpk_immut noalias nonnull readonly align 16 dereferenceable(320) %_4, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f)
  ret i1 %0
}

; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h156ca560897cf937E"({ [0 x i64]*, i64 }* mpk_immut noalias nocapture readonly align 8 dereferenceable(16) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
start:
  %entry.i.i = alloca i64*, align 8
  %_6.i = alloca %"core::fmt::DebugList.296", align 8
  ...
  %2 = bitcast %"core::fmt::DebugList.296"* %_6.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %2), !noalias !43
  %3 = tail call i128 @_ZN4core3fmt9Formatter10debug_list17h8147fa4f8cb43178E(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f), !noalias !43
  %.0..sroa_cast.i = bitcast %"core::fmt::DebugList.296"* %_6.i to i128*
...
bb3.i.i:                                          ; preds = %bb3.i.i, %bb3.lr.ph.i.i
  ...
  %_15.i.i = call align 8 dereferenceable(16) %"core::fmt::DebugList.296"* @_ZN4core3fmt8builders9DebugList5entry17h65db77502f12805cE(%"core::fmt::DebugList.296"* nonnull align 8 dereferenceable(16) %_6.i, {}* mpk_immut nonnull align 1 %_17.0.i.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i64**)*, i64, i64, i1 (i64**, %"core::fmt::Formatter.253"*)* }* @vtable.2 to [3 x i64]*))
...
"_ZN48_$LT$$u5b$T$u5d$$u20$as$u20$core..fmt..Debug$GT$3fmt17h89df9c7e42db439bE.exit": ; preds = %bb3.i.i, %start
  %8 = call zeroext i1 @_ZN4core3fmt8builders9DebugList6finish17h1110a7134d6ce275E(%"core::fmt::DebugList.296"* nonnull align 8 dereferenceable(16) %_6.i)
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %2), !noalias !43
  ret i1 %8
}

; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h2c97e1bbf9bed3c2E"(%"distributions::uniform::UniformInt<u64>.257"** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_33.i = alloca i64*, align 8
  %_25.i = alloca i64*, align 8
  %_17.i = alloca i64*, align 8
  %debug_trait_builder.i = alloca %"core::fmt::DebugStruct.299", align 8
  %_4 = load %"distributions::uniform::UniformInt<u64>.257"*, %"distributions::uniform::UniformInt<u64>.257"** %self, align 8, !nonnull !2
  %__self_0_0.i = getelementptr inbounds %"distributions::uniform::UniformInt<u64>.257", %"distributions::uniform::UniformInt<u64>.257"* %_4, i64 0, i32 0, i64 0
  %__self_0_1.i = getelementptr inbounds %"distributions::uniform::UniformInt<u64>.257", %"distributions::uniform::UniformInt<u64>.257"* %_4, i64 0, i32 3
  %__self_0_2.i = getelementptr inbounds %"distributions::uniform::UniformInt<u64>.257", %"distributions::uniform::UniformInt<u64>.257"* %_4, i64 0, i32 5
  %0 = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %0), !noalias !46
  %1 = tail call i128 @_ZN4core3fmt9Formatter12debug_struct17h966f42198588d5ffE(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [10 x i8] }>* @alloc1237 to [0 x i8]*), i64 10), !noalias !46
  %.0..sroa_cast.i = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder.i to i128*
  ...
  %_10.i = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder.i, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [3 x i8] }>* @alloc1238 to [0 x i8]*), i64 3, {}* mpk_immut nonnull align 1 %_14.0.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i64**)*, i64, i64, i1 (i64**, %"core::fmt::Formatter.253"*)* }* @vtable.7 to [3 x i64]*))
  ...
  %_18.i = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder.i, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [5 x i8] }>* @alloc1239 to [0 x i8]*), i64 5, {}* mpk_immut nonnull align 1 %_22.0.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i64**)*, i64, i64, i1 (i64**, %"core::fmt::Formatter.253"*)* }* @vtable.7 to [3 x i64]*))
  ...
  %_26.i = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder.i, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [1 x i8] }>* @alloc1240 to [0 x i8]*), i64 1, {}* mpk_immut nonnull align 1 %_30.0.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i64**)*, i64, i64, i1 (i64**, %"core::fmt::Formatter.253"*)* }* @vtable.7 to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %4), !noalias !46
  %5 = call zeroext i1 @_ZN4core3fmt8builders11DebugStruct6finish17h72e9687c51511b31E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder.i)
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %0), !noalias !46
  ret i1 %5
}

; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h37ac390e8963fd9aE"(i64** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_4 = load i64*, i64** %self, align 8, !nonnull !2
  %_3.i = tail call zeroext i1 @_ZN4core3fmt9Formatter15debug_lower_hex17h6ddb5559176c6045E(%"core::fmt::Formatter.253"* mpk_immut noalias nonnull readonly align 8 dereferenceable(64) %f), !noalias !49
  br i1 %_3.i, label %bb3.i, label %bb2.i

bb2.i:                                            ; preds = %start
  %_7.i = tail call zeroext i1 @_ZN4core3fmt9Formatter15debug_upper_hex17h61a2e870dc3af9acE(%"core::fmt::Formatter.253"* mpk_immut noalias nonnull readonly align 8 dereferenceable(64) %f)
  br i1 %_7.i, label %bb7.i, label %bb6.i

bb3.i:                                            ; preds = %start
  %0 = tail call zeroext i1 @"_ZN4core3fmt3num53_$LT$impl$u20$core..fmt..LowerHex$u20$for$u20$u64$GT$3fmt17he9d3331e4e8b2618E"(i64* mpk_immut noalias nonnull readonly align 8 dereferenceable(8) %_4, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f)
  br label %"_ZN4core3fmt3num50_$LT$impl$u20$core..fmt..Debug$u20$for$u20$u64$GT$3fmt17h53fc6197c54e613bE.exit"

bb6.i:                                            ; preds = %bb2.i
  %1 = tail call zeroext i1 @"_ZN4core3fmt3num3imp52_$LT$impl$u20$core..fmt..Display$u20$for$u20$u64$GT$3fmt17h4dc2af1a5829180dE"(i64* mpk_immut noalias nonnull readonly align 8 dereferenceable(8) %_4, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f)
  br label %"_ZN4core3fmt3num50_$LT$impl$u20$core..fmt..Debug$u20$for$u20$u64$GT$3fmt17h53fc6197c54e613bE.exit"

bb7.i:                                            ; preds = %bb2.i
  %2 = tail call zeroext i1 @"_ZN4core3fmt3num53_$LT$impl$u20$core..fmt..UpperHex$u20$for$u20$u64$GT$3fmt17h46c4aab50ded2d21E"(i64* mpk_immut noalias nonnull readonly align 8 dereferenceable(8) %_4, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f)
  br label %"_ZN4core3fmt3num50_$LT$impl$u20$core..fmt..Debug$u20$for$u20$u64$GT$3fmt17h53fc6197c54e613bE.exit"
...
; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h65e48835fafcbe1cE"(%"std::vec::IntoIter<usize>.271"** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_13.i = alloca { [0 x i64]*, i64 }, align 8
  %_6.i = alloca %"core::fmt::DebugTuple.298", align 8
  %_4 = load %"std::vec::IntoIter<usize>.271"*, %"std::vec::IntoIter<usize>.271"** %self, align 8, !nonnull !2
  %_4.idx = getelementptr %"std::vec::IntoIter<usize>.271", %"std::vec::IntoIter<usize>.271"* %_4, i64 0, i32 7
  %_4.idx.val = load i64*, i64** %_4.idx, align 8
  %_4.idx1 = getelementptr %"std::vec::IntoIter<usize>.271", %"std::vec::IntoIter<usize>.271"* %_4, i64 0, i32 9
  %0 = bitcast i64** %_4.idx1 to i64*
  %_4.idx1.val2 = load i64, i64* %0, align 8
  %1 = bitcast %"core::fmt::DebugTuple.298"* %_6.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %1)
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %_6.i, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [8 x i8] }>* @alloc1200 to [0 x i8]*), i64 8)
  ...
  %_4.i = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %_6.i, {}* mpk_immut nonnull align 1 %_10.0.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void ({ [0 x i64]*, i64 }*)*, i64, i64, i1 ({ [0 x i64]*, i64 }*, %"core::fmt::Formatter.253"*)* }* @vtable.4 to [3 x i64]*))
  %7 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %_4.i)
...
; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h6f81b967e2d08741E"({ i64*, i64* }** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_13.i = alloca { [0 x i64]*, i64 }, align 8
  %_6.i = alloca %"core::fmt::DebugTuple.298", align 8
  %_4 = load { i64*, i64* }*, { i64*, i64* }** %self, align 8, !nonnull !2
  %0 = bitcast %"core::fmt::DebugTuple.298"* %_6.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %0), !noalias !52
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %_6.i, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [4 x i8] }>* @alloc1205 to [0 x i8]*), i64 4), !noalias !52
  ...
  %_10.0.i = bitcast { [0 x i64]*, i64 }* %_13.i to {}*
  %_4.i = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %_6.i, {}* mpk_immut nonnull align 1 %_10.0.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void ({ [0 x i64]*, i64 }*)*, i64, i64, i1 ({ [0 x i64]*, i64 }*, %"core::fmt::Formatter.253"*)* }* @vtable.4 to [3 x i64]*)), !noalias !52
  %8 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %_4.i), !noalias !52
...
; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h7f48b8fcb63839ccE"(%"distributions::uniform::UniformInt<u32>.258"** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_33.i = alloca i32*, align 8
  %_25.i = alloca i32*, align 8
  %_17.i = alloca i32*, align 8
  %debug_trait_builder.i = alloca %"core::fmt::DebugStruct.299", align 8
  %_4 = load %"distributions::uniform::UniformInt<u32>.258"*, %"distributions::uniform::UniformInt<u32>.258"** %self, align 8, !nonnull !2
  %__self_0_0.i = getelementptr inbounds %"distributions::uniform::UniformInt<u32>.258", %"distributions::uniform::UniformInt<u32>.258"* %_4, i64 0, i32 0, i64 0
  %__self_0_1.i = getelementptr inbounds %"distributions::uniform::UniformInt<u32>.258", %"distributions::uniform::UniformInt<u32>.258"* %_4, i64 0, i32 3
  %__self_0_2.i = getelementptr inbounds %"distributions::uniform::UniformInt<u32>.258", %"distributions::uniform::UniformInt<u32>.258"* %_4, i64 0, i32 5
  %0 = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %0), !noalias !60
  %1 = tail call i128 @_ZN4core3fmt9Formatter12debug_struct17h966f42198588d5ffE(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [10 x i8] }>* @alloc1237 to [0 x i8]*), i64 10), !noalias !60
  %.0..sroa_cast.i = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder.i to i128*
  ...
  %_10.i = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder.i, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [3 x i8] }>* @alloc1238 to [0 x i8]*), i64 3, {}* mpk_immut nonnull align 1 %_14.0.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i32**)*, i64, i64, i1 (i32**, %"core::fmt::Formatter.253"*)* }* @vtable.1 to [3 x i64]*))
  ...
  %_18.i = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder.i, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [5 x i8] }>* @alloc1239 to [0 x i8]*), i64 5, {}* mpk_immut nonnull align 1 %_22.0.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i32**)*, i64, i64, i1 (i32**, %"core::fmt::Formatter.253"*)* }* @vtable.1 to [3 x i64]*))
  ...
  %_26.i = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder.i, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [1 x i8] }>* @alloc1240 to [0 x i8]*), i64 1, {}* mpk_immut nonnull align 1 %_30.0.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i32**)*, i64, i64, i1 (i32**, %"core::fmt::Formatter.253"*)* }* @vtable.1 to [3 x i64]*))
...
; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h84688a13dd8aaddeE"(%"distributions::uniform::Uniform<u64>.260"** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_13.i = alloca %"distributions::uniform::UniformInt<u64>.257"*, align 8
  %debug_trait_builder.i = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = bitcast %"distributions::uniform::Uniform<u64>.260"** %self to i64*
  %_41 = load i64, i64* %0, align 8, !range !63
  %1 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %1), !noalias !64
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %debug_trait_builder.i, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [7 x i8] }>* @alloc1232 to [0 x i8]*), i64 7), !noalias !64
  %2 = bitcast %"distributions::uniform::UniformInt<u64>.257"** %_13.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %2), !noalias !64
  %3 = bitcast %"distributions::uniform::UniformInt<u64>.257"** %_13.i to i64*
  store i64 %_41, i64* %3, align 8, !noalias !64
  %_10.0.i = bitcast %"distributions::uniform::UniformInt<u64>.257"** %_13.i to {}*
  %_8.i = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder.i, {}* mpk_immut nonnull align 1 %_10.0.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (%"distributions::uniform::UniformInt<u64>.257"**)*, i64, i64, i1 (%"distributions::uniform::UniformInt<u64>.257"**, %"core::fmt::Formatter.253"*)* }* @vtable.8 to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %2), !noalias !64
  %4 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder.i)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %1), !noalias !64
  ret i1 %4
}

; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h99ebe484993ae679E"({ i32*, i32* }** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  ...
  %_4.i = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %_6.i, {}* mpk_immut nonnull align 1 %_10.0.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void ({ [0 x i32]*, i64 }*)*, i64, i64, i1 ({ [0 x i32]*, i64 }*, %"core::fmt::Formatter.253"*)* }* @vtable.5 to [3 x i64]*)), !noalias !67
  %8 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %_4.i), !noalias !67
...
; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17h9a670d4538304c2dE"(i64** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_4 = load i64*, i64** %self, align 8, !nonnull !2
  %_3.i = tail call zeroext i1 @_ZN4core3fmt9Formatter15debug_lower_hex17h6ddb5559176c6045E(%"core::fmt::Formatter.253"* mpk_immut noalias nonnull readonly align 8 dereferenceable(64) %f), !noalias !75
  br i1 %_3.i, label %bb3.i, label %bb2.i
...
bb3.i:                                            ; preds = %start
  %0 = tail call zeroext i1 @"_ZN4core3fmt3num55_$LT$impl$u20$core..fmt..LowerHex$u20$for$u20$usize$GT$3fmt17h3fb07f7e6da8e1c6E"(i64* mpk_immut noalias nonnull readonly align 8 dereferenceable(8) %_4, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f)
  br label %"_ZN4core3fmt3num52_$LT$impl$u20$core..fmt..Debug$u20$for$u20$usize$GT$3fmt17hd033ec0476f2a15bE.exit"

bb6.i:                                            ; preds = %bb2.i
  %1 = tail call zeroext i1 @"_ZN4core3fmt3num3imp54_$LT$impl$u20$core..fmt..Display$u20$for$u20$usize$GT$3fmt17h0f57e3373191c50eE"(i64* mpk_immut noalias nonnull readonly align 8 dereferenceable(8) %_4, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f)
  br label %"_ZN4core3fmt3num52_$LT$impl$u20$core..fmt..Debug$u20$for$u20$usize$GT$3fmt17hd033ec0476f2a15bE.exit"

bb7.i:                                            ; preds = %bb2.i
  %2 = tail call zeroext i1 @"_ZN4core3fmt3num55_$LT$impl$u20$core..fmt..UpperHex$u20$for$u20$usize$GT$3fmt17hf3a9e839be306c07E"(i64* mpk_immut noalias nonnull readonly align 8 dereferenceable(8) %_4, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f)
  br label %"_ZN4core3fmt3num52_$LT$impl$u20$core..fmt..Debug$u20$for$u20$usize$GT$3fmt17hd033ec0476f2a15bE.exit"
...
; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17hbd0fb5f0e82e028fE"(%"std::io::Error.256"** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_4 = load %"std::io::Error.256"*, %"std::io::Error.256"** %self, align 8, !nonnull !2
  %0 = tail call zeroext i1 @"_ZN58_$LT$std..io..error..Error$u20$as$u20$core..fmt..Debug$GT$3fmt17h92bc210ff9abc8b7E"(%"std::io::Error.256"* mpk_immut noalias nonnull readonly align 8 dereferenceable(16) %_4, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f)
  ret i1 %0
}

; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17hbe11e245420fa081E"({ [0 x i32]*, i64 }* mpk_immut noalias nocapture readonly align 8 dereferenceable(16) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
start:
  ...
  %3 = tail call i128 @_ZN4core3fmt9Formatter10debug_list17h8147fa4f8cb43178E(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f), !noalias !78
  %.0..sroa_cast.i = bitcast %"core::fmt::DebugList.296"* %_6.i to i128*
...
bb3.i.i:                                          ; preds = %bb3.i.i, %bb3.lr.ph.i.i
  ...
  %_15.i.i = call align 8 dereferenceable(16) %"core::fmt::DebugList.296"* @_ZN4core3fmt8builders9DebugList5entry17h65db77502f12805cE(%"core::fmt::DebugList.296"* nonnull align 8 dereferenceable(16) %_6.i, {}* mpk_immut nonnull align 1 %_17.0.i.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i32**)*, i64, i64, i1 (i32**, %"core::fmt::Formatter.253"*)* }* @vtable.1 to [3 x i64]*))
...
; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17hc2ea958c0fbd8084E"(%"distributions::uniform::Uniform<u32>.261"** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_13.i = alloca %"distributions::uniform::UniformInt<u32>.258"*, align 8
  %debug_trait_builder.i = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = bitcast %"distributions::uniform::Uniform<u32>.261"** %self to i64*
  %_41 = load i64, i64* %0, align 8, !range !63
  %1 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %1), !noalias !81
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %debug_trait_builder.i, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [7 x i8] }>* @alloc1232 to [0 x i8]*), i64 7), !noalias !81
  %2 = bitcast %"distributions::uniform::UniformInt<u32>.258"** %_13.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %2), !noalias !81
  %3 = bitcast %"distributions::uniform::UniformInt<u32>.258"** %_13.i to i64*
  store i64 %_41, i64* %3, align 8, !noalias !81
  %_10.0.i = bitcast %"distributions::uniform::UniformInt<u32>.258"** %_13.i to {}*
  %_8.i = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder.i, {}* mpk_immut nonnull align 1 %_10.0.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (%"distributions::uniform::UniformInt<u32>.258"**)*, i64, i64, i1 (%"distributions::uniform::UniformInt<u32>.258"**, %"core::fmt::Formatter.253"*)* }* @vtable.9 to [3 x i64]*))
...
; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17hd718dec522aaa46bE"(%"std::vec::Vec<u32>.269"** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
start:
  %entry.i.i.i = alloca i32*, align 8
  %_6.i.i = alloca %"core::fmt::DebugList.296", align 8
  %_4 = load %"std::vec::Vec<u32>.269"*, %"std::vec::Vec<u32>.269"** %self, align 8, !nonnull !2
  %0 = bitcast %"std::vec::Vec<u32>.269"* %_4 to [0 x i32]**
  %_3.idx.val.i1.i.i = load [0 x i32]*, [0 x i32]** %0, align 8, !alias.scope !84, !nonnull !2
  %1 = getelementptr inbounds %"std::vec::Vec<u32>.269", %"std::vec::Vec<u32>.269"* %_4, i64 0, i32 3
  %_4.i.i = load i64, i64* %1, align 8, !alias.scope !91
  %2 = bitcast %"core::fmt::DebugList.296"* %_6.i.i to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %2), !noalias !92
  %3 = tail call i128 @_ZN4core3fmt9Formatter10debug_list17h8147fa4f8cb43178E(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f), !noalias !92
  %.0..sroa_cast.i.i = bitcast %"core::fmt::DebugList.296"* %_6.i.i to i128*
...
bb3.i.i.i:                                        ; preds = %bb3.i.i.i, %bb3.lr.ph.i.i.i
  ...
  %_15.i.i.i = call align 8 dereferenceable(16) %"core::fmt::DebugList.296"* @_ZN4core3fmt8builders9DebugList5entry17h65db77502f12805cE(%"core::fmt::DebugList.296"* nonnull align 8 dereferenceable(16) %_6.i.i, {}* mpk_immut nonnull align 1 %_17.0.i.i.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i32**)*, i64, i64, i1 (i32**, %"core::fmt::Formatter.253"*)* }* @vtable.1 to [3 x i64]*)), !noalias !95
...
"_ZN61_$LT$alloc..vec..Vec$LT$T$GT$$u20$as$u20$core..fmt..Debug$GT$3fmt17hefd9ae3f082171b2E.exit": ; preds = %bb3.i.i.i, %start
  %8 = call zeroext i1 @_ZN4core3fmt8builders9DebugList6finish17h1110a7134d6ce275E(%"core::fmt::DebugList.296"* nonnull align 8 dereferenceable(16) %_6.i.i), !noalias !95
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %2), !noalias !92
  ret i1 %8
}

; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17heeec9cc1e9046680E"(i32** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_4 = load i32*, i32** %self, align 8, !nonnull !2
  %_3.i = tail call zeroext i1 @_ZN4core3fmt9Formatter15debug_lower_hex17h6ddb5559176c6045E(%"core::fmt::Formatter.253"* mpk_immut noalias nonnull readonly align 8 dereferenceable(64) %f), !noalias !96
  br i1 %_3.i, label %bb3.i, label %bb2.i
...
bb3.i:                                            ; preds = %start
  %0 = tail call zeroext i1 @"_ZN4core3fmt3num53_$LT$impl$u20$core..fmt..LowerHex$u20$for$u20$u32$GT$3fmt17hbdab60765508c6f3E"(i32* mpk_immut noalias nonnull readonly align 4 dereferenceable(4) %_4, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f)
  br label %"_ZN4core3fmt3num50_$LT$impl$u20$core..fmt..Debug$u20$for$u20$u32$GT$3fmt17h2b0660fe54bf7b67E.exit"

bb6.i:                                            ; preds = %bb2.i
  %1 = tail call zeroext i1 @"_ZN4core3fmt3num3imp52_$LT$impl$u20$core..fmt..Display$u20$for$u20$u32$GT$3fmt17h6b8b41e24df1a43fE"(i32* mpk_immut noalias nonnull readonly align 4 dereferenceable(4) %_4, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f)
  br label %"_ZN4core3fmt3num50_$LT$impl$u20$core..fmt..Debug$u20$for$u20$u32$GT$3fmt17h2b0660fe54bf7b67E.exit"

bb7.i:                                            ; preds = %bb2.i
  %2 = tail call zeroext i1 @"_ZN4core3fmt3num53_$LT$impl$u20$core..fmt..UpperHex$u20$for$u20$u32$GT$3fmt17h4773017a326a508bE"(i32* mpk_immut noalias nonnull readonly align 4 dereferenceable(4) %_4, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f)
  br label %"_ZN4core3fmt3num50_$LT$impl$u20$core..fmt..Debug$u20$for$u20$u32$GT$3fmt17h2b0660fe54bf7b67E.exit"
...
; Function Attrs: nonlazybind uwtable
define internal zeroext i1 @"_ZN42_$LT$$RF$T$u20$as$u20$core..fmt..Debug$GT$3fmt17hf67ad8a0bdc4010aE"(%"std::vec::IntoIter<u32>.273"** mpk_immut noalias nocapture readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_13.i = alloca { [0 x i32]*, i64 }, align 8
  %_6.i = alloca %"core::fmt::DebugTuple.298", align 8
  %_4 = load %"std::vec::IntoIter<u32>.273"*, %"std::vec::IntoIter<u32>.273"** %self, align 8, !nonnull !2
  %_4.idx = getelementptr %"std::vec::IntoIter<u32>.273", %"std::vec::IntoIter<u32>.273"* %_4, i64 0, i32 7
  %_4.idx.val = load i32*, i32** %_4.idx, align 8
  %_4.idx1 = getelementptr %"std::vec::IntoIter<u32>.273", %"std::vec::IntoIter<u32>.273"* %_4, i64 0, i32 9
  ...
  store i64 %5, i64* %.fca.1.gep.i, align 8
  %_10.0.i = bitcast { [0 x i32]*, i64 }* %_13.i to {}*
  %_4.i = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %_6.i, {}* mpk_immut nonnull align 1 %_10.0.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void ({ [0 x i32]*, i64 }*)*, i64, i64, i1 ({ [0 x i32]*, i64 }*, %"core::fmt::Formatter.253"*)* }* @vtable.5 to [3 x i64]*))
  %7 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %_4.i)
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %2)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %1)
  ret i1 %7
...
; Function Attrs: norecurse nounwind nonlazybind readnone uwtable
define internal void @_ZN4core3ptr13drop_in_place17h0a3829747c41c821E(%"distributions::uniform::UniformInt<u32>.258"** mpk_unsafe nocapture %_1) unnamed_addr #1 {
start:
  ret void
}

; Function Attrs: nonlazybind uwtable
define internal void @_ZN4core3ptr13drop_in_place17h5a43ebe0868d6058E(%"std::io::Error.256"* mpk_unsafe nocapture readonly %_1) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
start:
  %0 = bitcast %"std::io::Error.256"* %_1 to i8*
  %1 = load i8, i8* %0, align 8, !range !4
  %switch.i = icmp ult i8 %1, 2
  br i1 %switch.i, label %_ZN4core3ptr13drop_in_place17hf2c56fadd165bb9fE.exit, label %bb2.i

bb2.i:                                            ; preds = %start
  %2 = getelementptr inbounds %"std::io::Error.256", %"std::io::Error.256"* %_1, i64 0, i32 1, i32 2, i64 7
  %3 = bitcast i8* %2 to %"std::io::error::Custom.300"**
  %4 = load %"std::io::error::Custom.300"*, %"std::io::error::Custom.300"** %3, align 8, !nonnull !2
  %5 = bitcast %"std::io::error::Custom.300"* %4 to {}**
  %6 = load {}*, {}** %5, align 8, !nonnull !2
  %7 = getelementptr inbounds %"std::io::error::Custom.300", %"std::io::error::Custom.300"* %4, i64 0, i32 1, i32 1
...
bb3.i.i.i.i.i.i:                                  ; preds = %bb3.i.i.i.i
  %16 = bitcast %"std::io::error::Custom.300"* %4 to i8**
...
cleanup.i.i.i.i:                                  ; preds = %bb2.i
  %20 = landingpad { i8*, i32 }
          cleanup
  %21 = bitcast %"std::io::error::Custom.300"* %4 to i8**
...
; Function Attrs: nonlazybind uwtable
define internal fastcc void @_ZN4core3ptr13drop_in_place17h8a309588a863a042E({ i8*, i64* }* mpk_unsafe nocapture readonly %_1) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
start:
...
define internal fastcc void @_ZN5alloc5alloc8box_free17h8b88da437f025736E(i64* mpk_immut mpk_unsafe nonnull %0) unnamed_addr #4 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
...
; Function Attrs: inlinehint nounwind nonlazybind uwtable
define internal fastcc void @_ZN5alloc5alloc8box_free17hf0630702f10cc180E(i8* mpk_immut mpk_unsafe nonnull %0, i64* mpk_immut noalias readonly align 8 dereferenceable(24) %1) unnamed_addr #4 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
start:
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN85_$LT$rand..distributions..bernoulli..BernoulliError$u20$as$u20$core..fmt..Display$GT$3fmt17h7a60ab23b4babb4dE"(%"distributions::bernoulli::BernoulliError::InvalidProbability.274"* mpk_immut noalias nocapture nonnull readonly align 1 %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %0 = tail call zeroext i1 @_ZN4core3fmt9Formatter9write_str17hdd0117a4487b56c4E(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [45 x i8] }>* @alloc1215 to [0 x i8]*), i64 45)
  ret i1 %0
}

; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN77_$LT$rand..distributions..slice..EmptySlice$u20$as$u20$core..fmt..Display$GT$3fmt17had9a851e70b24082E"(%"distributions::slice::EmptySlice.275"* mpk_immut noalias nocapture nonnull readonly align 1 %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_4 = alloca %"core::fmt::Arguments.297", align 8
  %0 = bitcast %"core::fmt::Arguments.297"* %_4 to i8*
  call void @llvm.lifetime.start.p0i8(i64 48, i8* nonnull %0)
  %1 = bitcast %"core::fmt::Arguments.297"* %_4 to [0 x { [0 x i8]*, i64 }]**
  store [0 x { [0 x i8]*, i64 }]* bitcast (<{ i8*, [8 x i8] }>* @alloc1004 to [0 x { [0 x i8]*, i64 }]*), [0 x { [0 x i8]*, i64 }]** %1, align 8, !alias.scope !105, !noalias !108
  %2 = getelementptr inbounds %"core::fmt::Arguments.297", %"core::fmt::Arguments.297"* %_4, i64 0, i32 1, i32 1
  store i64 1, i64* %2, align 8, !alias.scope !105, !noalias !108
  %3 = getelementptr inbounds %"core::fmt::Arguments.297", %"core::fmt::Arguments.297"* %_4, i64 0, i32 3, i32 0
  store i64* null, i64** %3, align 8, !alias.scope !105, !noalias !108
  %4 = getelementptr inbounds %"core::fmt::Arguments.297", %"core::fmt::Arguments.297"* %_4, i64 0, i32 5, i32 0
  store [0 x { i8*, i64* }]* bitcast (<{ [0 x i8] }>* @alloc1006 to [0 x { i8*, i64* }]*), [0 x { i8*, i64* }]** %4, align 8, !alias.scope !105, !noalias !108
  %5 = getelementptr inbounds %"core::fmt::Arguments.297", %"core::fmt::Arguments.297"* %_4, i64 0, i32 5, i32 1
  store i64 0, i64* %5, align 8, !alias.scope !105, !noalias !108
  %6 = call zeroext i1 @_ZN4core3fmt9Formatter9write_fmt17h767ce03da9bc508fE(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, %"core::fmt::Arguments.297"* noalias nocapture nonnull dereferenceable(48) %_4)
  call void @llvm.lifetime.end.p0i8(i64 48, i8* nonnull %0)
  ret i1 %6
}

; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN89_$LT$rand..distributions..weighted_index..WeightedError$u20$as$u20$core..fmt..Display$GT$3fmt17h00b9b924807a80d1E"(i8* mpk_immut noalias nocapture readonly align 1 dereferenceable(1) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
...
bb6:                                              ; preds = %bb5, %bb4, %bb3, %start
  ...
  %1 = tail call zeroext i1 @_ZN4core3fmt9Formatter9write_str17hdd0117a4487b56c4E(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 %_4.sroa.0.0, i64 %_4.sroa.7.0)
  ret i1 %1
}
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN75_$LT$rand..rngs..adapter..read..ReadError$u20$as$u20$core..fmt..Display$GT$3fmt17ha27d4b82ffbcb3d0E"(%"rngs::adapter::read::ReadError.276"* mpk_immut noalias readonly align 8 dereferenceable(16) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  ...
  %2 = bitcast [1 x { i8*, i64* }]* %_11 to %"rngs::adapter::read::ReadError.276"**
  store %"rngs::adapter::read::ReadError.276"* %self, %"rngs::adapter::read::ReadError.276"** %2, align 8
  %3 = getelementptr inbounds [1 x { i8*, i64* }], [1 x { i8*, i64* }]* %_11, i64 0, i64 0, i32 1
  store i64* bitcast (i1 (%"std::io::Error.256"*, %"core::fmt::Formatter.253"*)* @"_ZN60_$LT$std..io..error..Error$u20$as$u20$core..fmt..Display$GT$3fmt17ha444a7daee083529E" to i64*), i64** %3, align 8
  %4 = bitcast %"core::fmt::Arguments.297"* %_4 to [0 x { [0 x i8]*, i64 }]**
  store [0 x { [0 x i8]*, i64 }]* bitcast (<{ i8*, [8 x i8] }>* @alloc1019 to [0 x { [0 x i8]*, i64 }]*), [0 x { [0 x i8]*, i64 }]** %4, align 8, !alias.scope !112, !noalias !115
  %5 = getelementptr inbounds %"core::fmt::Arguments.297", %"core::fmt::Arguments.297"* %_4, i64 0, i32 1, i32 1
  store i64 1, i64* %5, align 8, !alias.scope !112, !noalias !115
  %6 = getelementptr inbounds %"core::fmt::Arguments.297", %"core::fmt::Arguments.297"* %_4, i64 0, i32 3, i32 0
  store i64* null, i64** %6, align 8, !alias.scope !112, !noalias !115
  %7 = getelementptr inbounds %"core::fmt::Arguments.297", %"core::fmt::Arguments.297"* %_4, i64 0, i32 5, i32 0
  %8 = bitcast [0 x { i8*, i64* }]** %7 to [1 x { i8*, i64* }]**
  store [1 x { i8*, i64* }]* %_11, [1 x { i8*, i64* }]** %8, align 8, !alias.scope !112, !noalias !115
  %9 = getelementptr inbounds %"core::fmt::Arguments.297", %"core::fmt::Arguments.297"* %_4, i64 0, i32 5, i32 1
  store i64 1, i64* %9, align 8, !alias.scope !112, !noalias !115
  %10 = call zeroext i1 @_ZN4core3fmt9Formatter9write_fmt17h767ce03da9bc508fE(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, %"core::fmt::Arguments.297"* noalias nocapture nonnull dereferenceable(48) %_4)
  call void @llvm.lifetime.end.p0i8(i64 48, i8* nonnull %0)
...
; Function Attrs: norecurse nounwind nonlazybind readnone uwtable
define { i8*, i8* } @"_ZN74_$LT$rand..rngs..adapter..read..ReadError$u20$as$u20$std..error..Error$GT$6source17h5bf795ca26e64e50E"(%"rngs::adapter::read::ReadError.276"* mpk_immut noalias readonly align 8 dereferenceable(16) %self) unnamed_addr #1 {
start:
  %0 = bitcast %"rngs::adapter::read::ReadError.276"* %self to i8*
  %1 = insertvalue { i8*, i8* } undef, i8* %0, 0
  %2 = insertvalue { i8*, i8* } %1, i8* bitcast ({ void (%"std::io::Error.256"*)*, i64, i64, { i8*, i8* } (%"std::io::Error.256"*)*, i64 (%"std::io::Error.256"*)*, i64* (%"std::io::Error.256"*)*, { [0 x i8]*, i64 } (%"std::io::Error.256"*)*, { i8*, i8* } (%"std::io::Error.256"*)*, i1 (%"std::io::Error.256"*, %"core::fmt::Formatter.253"*)*, i1 (%"std::io::Error.256"*, %"core::fmt::Formatter.253"*)* }* @vtable.6 to i8*), 1
  ret { i8*, i8* } %2
}

; Function Attrs: noinline nonlazybind uwtable
define internal fastcc void @"_ZN4rand4rngs7adapter9reseeding29ReseedingCore$LT$R$C$Rsdr$GT$19reseed_and_generate17h9a5f437ee668e72aE"(%"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278"* align 16 dereferenceable(80) %self, %"rand_chacha::chacha::Array64<u32>.262"* align 4 dereferenceable(256) %0, i64 %global_fork_counter) unnamed_addr #2 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
start:
  %_2.i.i.i = alloca %"rand_chacha::guts::ChaCha.264", align 16
  ...
  %.cast.i = bitcast %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278"* %self to %"rand_core::OsRng.277"*
  ...
  %2 = call { i8*, i8* } @"_ZN59_$LT$rand_core..os..OsRng$u20$as$u20$rand_core..RngCore$GT$14try_fill_bytes17hd80590ef176c258cE"(%"rand_core::OsRng.277"* nonnull align 1 %.cast.i, [0 x i8]* nonnull align 1 %_5.0.i.i.i, i64 32), !noalias !118
...
"_ZN4rand4rngs7adapter9reseeding29ReseedingCore$LT$R$C$Rsdr$GT$6reseed17h737cf6191a2bc75bE.exit.thread": ; preds = %start
  ...
  %5 = bitcast %"rand_chacha::guts::ChaCha.264"* %_2.i.i.i to i8*
  ...
  %6 = getelementptr inbounds %"rand_chacha::guts::ChaCha.264", %"rand_chacha::guts::ChaCha.264"* %_2.i.i.i, i64 0, i32 0, i64 0
  %_14.sroa.0.i.sroa.0.0.copyload.i27 = load i64, i64* %6, align 16, !noalias !128
  %_14.sroa.0.i.sroa.4.0..sroa_idx.i = getelementptr inbounds %"rand_chacha::guts::ChaCha.264", %"rand_chacha::guts::ChaCha.264"* %_2.i.i.i, i64 0, i32 1, i32 0, i64 1
  ...
  %7 = getelementptr inbounds %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278", %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278"* %self, i64 0, i32 5
  %_3.i.i.i = load i64, i64* %7, align 16, !noalias !129
  %8 = getelementptr inbounds %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278", %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278"* %self, i64 0, i32 7
  store i64 %_3.i.i.i, i64* %8, align 8, !noalias !129
  %9 = bitcast %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278"* %self to i64*
  store i64 %_14.sroa.0.i.sroa.0.0.copyload.i27, i64* %9, align 16
  %_2.sroa.11.16._7.sroa.0.0._4.sroa.0.0..sroa_idx.i.sroa_idx.i.sroa_idx.i = getelementptr inbounds %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278", %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278"* %self, i64 0, i32 3, i32 1, i32 1, i32 0, i64 1
...
bb13:                                             ; preds = %bb3.i.i.i.i4, %bb3.i.i3, %"_ZN4rand4rngs7adapter9reseeding29ReseedingCore$LT$R$C$Rsdr$GT$6reseed17h737cf6191a2bc75bE.exit.thread"
  %self.idx = getelementptr %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278", %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278"* %self, i64 0, i32 9
  store i64 %global_fork_counter, i64* %self.idx, align 16
  %23 = getelementptr inbounds %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278", %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278"* %self, i64 0, i32 5
  %_18 = load i64, i64* %23, align 16
  %24 = getelementptr inbounds %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278", %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278"* %self, i64 0, i32 7
  %25 = add i64 %_18, -256
  store i64 %25, i64* %24, align 8
  %_4.i = bitcast %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278"* %self to %"rand_chacha::guts::ChaCha.264"*
  %_8.i = bitcast %"rand_chacha::chacha::Array64<u32>.262"* %0 to [256 x i8]*
  call void @_ZN11rand_chacha4guts11refill_wide17hd8b631cf1edebeabE(%"rand_chacha::guts::ChaCha.264"* nonnull align 16 dereferenceable(48) %_4.i, i32 6, [256 x i8]* nonnull align 1 dereferenceable(256) %_8.i)
  ret void
}
...
; Function Attrs: nonlazybind uwtable
define void @_ZN4rand4rngs7adapter9reseeding4fork21register_fork_handler17hae16271d26bba373E() unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
start:
...
; Function Attrs: nonlazybind uwtable
define mpk_immut nonnull i64* @_ZN4rand4rngs6thread10thread_rng17hfd41523429766425E() unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
start:
  %e.i.i = alloca %"std::thread::AccessError.254", align 1, !MPK-Extern-Move !137
...
"_ZN3std6thread5local17LocalKey$LT$T$GT$8try_with17h3baad387233de778E.exit.thread.i": ; preds = %_ZN4rand4rngs6thread14THREAD_RNG_KEY7__getit17h03f91347e3b79c52E.exit.i.i
  %5 = getelementptr inbounds %"std::thread::AccessError.254", %"std::thread::AccessError.254"* %e.i.i, i64 0, i32 0, i64 0, !MPK-Unsafe2 !142
  call void @llvm.lifetime.start.p0i8(i64 0, i8* nonnull %5)
  %_6.0.i.i = bitcast %"std::thread::AccessError.254"* %e.i.i to {}*, !MPK-Unsafe2 !142
  call void @_ZN4core6result13unwrap_failed17hf1bf530e85f5bb70E([0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [70 x i8] }>* @alloc1181 to [0 x i8]*), i64 70, {}* mpk_immut nonnull align 1 %_6.0.i.i, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (%"std::thread::AccessError.254"*)*, i64, i64, i1 (%"std::thread::AccessError.254"*, %"core::fmt::Formatter.253"*)* }* @vtable.3 to [3 x i64]*), %"core::panic::Location.289"* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast (<{ i8*, [16 x i8] }>* @alloc1183 to %"core::panic::Location.289"*))
  br label %UnifiedUnreachableBlock
...
start:
  ...
  %_3.i = bitcast i64* %0 to %"rand_core::block::BlockRng<rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>>.301"*
...
bb4.lr.ph.i.i:                                    ; preds = %start
  ...
  %2 = bitcast i64* %1 to %"rand_chacha::chacha::Array64<u32>.262"*
  %3 = getelementptr inbounds i64, i64* %self.val, i64 36
  %4 = bitcast i64* %3 to %"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278"*
  %5 = getelementptr inbounds i64, i64* %self.val, i64 43
  %6 = getelementptr i64, i64* %self.val, i64 44
  %_4.i.i.i.i.i = bitcast i64* %3 to %"rand_chacha::guts::ChaCha.264"*
...
bb7.i.i.i.i:                                      ; preds = %bb4.i.i.i.i
  ...
  tail call void @_ZN11rand_chacha4guts11refill_wide17hd8b631cf1edebeabE(%"rand_chacha::guts::ChaCha.264"* nonnull align 16 dereferenceable(48) %_4.i.i.i.i.i, i32 6, [256 x i8]* nonnull align 1 dereferenceable(256) %_8.i.i.i.i.i)
...
bb8.i.i.i.i:                                      ; preds = %bb4.i.i.i.i, %bb8.i.i
  tail call fastcc void @"_ZN4rand4rngs7adapter9reseeding29ReseedingCore$LT$R$C$Rsdr$GT$19reseed_and_generate17h9a5f437ee668e72aE"(%"rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>.278"* nonnull align 16 dereferenceable(80) %4, %"rand_chacha::chacha::Array64<u32>.262"* nonnull align 4 dereferenceable(256) %2, i64 %7)
  br label %"_ZN9rand_core5block17BlockRng$LT$R$GT$16generate_and_set17h3cb76737c7c47ff8E.exit.i.i"
...
bb3.i.i.i.i:                                      ; preds = %"_ZN4core5slice5index74_$LT$impl$u20$core..ops..index..Index$LT$I$GT$$u20$for$u20$$u5b$T$u5d$$GT$5index17h6d950956d0bb1b7eE.exit.i.i"
  tail call void @_ZN4core5slice5index26slice_start_index_len_fail17h2ad4471ff7be2fa2E(i64 %read_len.011.i.i, i64 %dest.1, %"core::panic::Location.289"* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast (<{ i8*, [16 x i8] }>* @alloc1209 to %"core::panic::Location.289"*))
  unreachable
...
"_ZN4core5slice5index77_$LT$impl$u20$core..ops..index..IndexMut$LT$I$GT$$u20$for$u20$$u5b$T$u5d$$GT$9index_mut17hf33f7ca9532c84d4E.exit.i.i": ; preds = %"_ZN4core5slice5index74_$LT$impl$u20$core..ops..index..Index$LT$I$GT$$u20$for$u20$$u5b$T$u5d$$GT$5index17h6d950956d0bb1b7eE.exit.i.i"
  %11 = getelementptr inbounds %"rand_core::block::BlockRng<rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>>.301", %"rand_core::block::BlockRng<rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>>.301"* %_3.i, i64 0, i32 3, i32 0, i64 %_26.i.i
...
bb4.lr.ph.i.i.i:                                  ; preds = %start
  ...
  %5 = getelementptr inbounds i64, i64* %self.val, i64 43
  %6 = getelementptr i64, i64* %self.val, i64 44
  %_4.i.i.i.i.i.i = bitcast i64* %3 to %"rand_chacha::guts::ChaCha.264"*
...
bb7.i.i.i.i.i:                                    ; preds = %bb4.i.i.i.i.i
  ...
  store i64 %10, i64* %5, align 8
  tail call void @_ZN11rand_chacha4guts11refill_wide17hd8b631cf1edebeabE(%"rand_chacha::guts::ChaCha.264"* nonnull align 16 dereferenceable(48) %_4.i.i.i.i.i.i, i32 6, [256 x i8]* nonnull align 1 dereferenceable(256) %_8.i.i.i.i.i.i)
...
bb3.i.i.i.i.i:                                    ; preds = %"_ZN4core5slice5index74_$LT$impl$u20$core..ops..index..Index$LT$I$GT$$u20$for$u20$$u5b$T$u5d$$GT$5index17h6d950956d0bb1b7eE.exit.i.i.i"
  tail call void @_ZN4core5slice5index26slice_start_index_len_fail17h2ad4471ff7be2fa2E(i64 %read_len.011.i.i.i, i64 %dest.1, %"core::panic::Location.289"* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast (<{ i8*, [16 x i8] }>* @alloc1209 to %"core::panic::Location.289"*))
  unreachable
...
"_ZN4core5slice5index77_$LT$impl$u20$core..ops..index..IndexMut$LT$I$GT$$u20$for$u20$$u5b$T$u5d$$GT$9index_mut17hf33f7ca9532c84d4E.exit.i.i.i": ; preds = %"_ZN4core5slice5index74_$LT$impl$u20$core..ops..index..Index$LT$I$GT$$u20$for$u20$$u5b$T$u5d$$GT$5index17h6d950956d0bb1b7eE.exit.i.i.i"
  %11 = getelementptr inbounds %"rand_core::block::BlockRng<rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>>.301", %"rand_core::block::BlockRng<rngs::adapter::reseeding::ReseedingCore<rand_chacha::ChaCha12Core, rand_core::OsRng>>.301"* %_3.i, i64 0, i32 3, i32 0, i64 %_26.i.i.i
  %12 = bitcast i32* %11 to [0 x i32]*
...
; Function Attrs: nounwind nonlazybind uwtable
define zeroext i1 @"_ZN67_$LT$rand..seq..index..IndexVec$u20$as$u20$core..cmp..PartialEq$GT$2eq17h8017f7092cbfeeefE"(%"seq::index::IndexVec.279"* mpk_immut noalias readonly align 8 dereferenceable(32) %self, %"seq::index::IndexVec.279"* mpk_immut noalias readonly align 8 dereferenceable(32) %other) unnamed_addr #5 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
start:
  %0 = getelementptr inbounds %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %self, i64 0, i32 0, i64 0
  %_8 = load i64, i64* %0, align 8, !range !153
  %switch.not = icmp eq i64 %_8, 1
  %1 = getelementptr inbounds %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %other, i64 0, i32 0, i64 0
  %_6 = load i64, i64* %1, align 8, !range !153
  %switch11.not = icmp eq i64 %_6, 1
  %2 = getelementptr inbounds %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %self, i64 0, i32 2
  %3 = getelementptr inbounds %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %other, i64 0, i32 2
...
bb4:                                              ; preds = %bb3
  %4 = getelementptr %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %self, i64 0, i32 2, i64 2
  %.idx25.val = load i64, i64* %4, align 8
  store i64 -5596821061263218879, i64* @METASAFE_TYPE_ID, align 8
  %5 = getelementptr %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %other, i64 0, i32 2, i64 2
...
bb5:                                              ; preds = %bb1
  ...
  %7 = getelementptr inbounds %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %self, i64 0, i32 2, i64 2
  ...
  %9 = getelementptr inbounds %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %other, i64 0, i32 2, i64 2
...
bb7:                                              ; preds = %bb3
  ...
  %14 = getelementptr inbounds %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %self, i64 0, i32 2, i64 2
  ...
  %16 = getelementptr inbounds %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %other, i64 0, i32 2, i64 2
...
bb9:                                              ; preds = %bb1
  %20 = getelementptr %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %self, i64 0, i32 2, i64 2
  %.idx26.val = load i64, i64* %20, align 8
  store i64 8766594652559642870, i64* @METASAFE_TYPE_ID, align 8
  %21 = getelementptr %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %other, i64 0, i32 2, i64 2
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN78_$LT$rand..distributions..bernoulli..Bernoulli$u20$as$u20$core..fmt..Debug$GT$3fmt17h7a0f2d9545fd3f88E"(i64* mpk_immut noalias readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_15 = alloca i64*, align 8
  %debug_trait_builder = alloca %"core::fmt::DebugStruct.299", align 8
  %0 = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %0)
  %1 = tail call i128 @_ZN4core3fmt9Formatter12debug_struct17h966f42198588d5ffE(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [9 x i8] }>* @alloc1220 to [0 x i8]*), i64 9)
  %.0..sroa_cast = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder to i128*
  store i128 %1, i128* %.0..sroa_cast, align 8
  %2 = bitcast i64** %_15 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %2)
  store i64* %self, i64** %_15, align 8
  %_12.0 = bitcast i64** %_15 to {}*
  %_8 = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [5 x i8] }>* @alloc1221 to [0 x i8]*), i64 5, {}* mpk_immut nonnull align 1 %_12.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i64**)*, i64, i64, i1 (i64**, %"core::fmt::Formatter.253"*)* }* @vtable.7 to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %2)
  %3 = call zeroext i1 @_ZN4core3fmt8builders11DebugStruct6finish17h72e9687c51511b31E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder)
...
start:
  %debug_trait_builder = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %0)
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %debug_trait_builder, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [18 x i8] }>* @alloc1222 to [0 x i8]*), i64 18)
  %1 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %0)
  ret i1 %1
}

; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN77_$LT$rand..distributions..float..OpenClosed01$u20$as$u20$core..fmt..Debug$GT$3fmt17h73c99e4758b8e407E"(%"distributions::float::OpenClosed01.280"* mpk_immut noalias nocapture nonnull readonly align 1 %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %debug_trait_builder = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %0)
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN71_$LT$rand..distributions..float..Open01$u20$as$u20$core..fmt..Debug$GT$3fmt17h690316ebcaa06291E"(%"distributions::float::Open01.281"* mpk_immut noalias nocapture nonnull readonly align 1 %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %debug_trait_builder = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %0)
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN77_$LT$rand..distributions..other..Alphanumeric$u20$as$u20$core..fmt..Debug$GT$3fmt17h373636c2502edc56E"(%"distributions::other::Alphanumeric.282"* mpk_immut noalias nocapture nonnull readonly align 1 %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %debug_trait_builder = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %0)
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN75_$LT$rand..distributions..slice..EmptySlice$u20$as$u20$core..fmt..Debug$GT$3fmt17h48d511edd2852164E"(%"distributions::slice::EmptySlice.275"* mpk_immut noalias nocapture nonnull readonly align 1 %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %debug_trait_builder = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %0)
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN87_$LT$rand..distributions..weighted_index..WeightedError$u20$as$u20$core..fmt..Debug$GT$3fmt17hb6d49a3d98d541f0E"(i8* mpk_immut noalias nocapture readonly align 1 dereferenceable(1) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %debug_trait_builder3 = alloca %"core::fmt::DebugTuple.298", align 8
  %debug_trait_builder2 = alloca %"core::fmt::DebugTuple.298", align 8
  %debug_trait_builder1 = alloca %"core::fmt::DebugTuple.298", align 8
  %debug_trait_builder = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = load i8, i8* %self, align 1, !range !111
  %_5 = zext i8 %0 to i64
  switch i64 %_5, label %bb2 [
...
bb1:                                              ; preds = %start
  %1 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %1)
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %debug_trait_builder3, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [7 x i8] }>* @alloc1227 to [0 x i8]*), i64 7)
  %2 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder3)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %1)
  br label %bb14
...
bb3:                                              ; preds = %start
  %3 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3)
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %debug_trait_builder, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [6 x i8] }>* @alloc1230 to [0 x i8]*), i64 6)
  %4 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3)
  br label %bb14

bb6:                                              ; preds = %start
  %5 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %5)
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %debug_trait_builder1, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [13 x i8] }>* @alloc1229 to [0 x i8]*), i64 13)
  %6 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder1)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %5)
  br label %bb14

bb9:                                              ; preds = %start
  %7 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %7)
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %debug_trait_builder2, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [14 x i8] }>* @alloc1228 to [0 x i8]*), i64 14)
  %8 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder2)
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN78_$LT$rand..distributions..uniform..UniformChar$u20$as$u20$core..fmt..Debug$GT$3fmt17h1efc8fcda8ffe99fE"(%"distributions::uniform::UniformChar.283"* mpk_immut noalias readonly align 4 dereferenceable(12) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_15 = alloca %"distributions::uniform::UniformInt<u32>.258"*, align 8
  %debug_trait_builder = alloca %"core::fmt::DebugStruct.299", align 8
  %0 = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %0)
  %1 = tail call i128 @_ZN4core3fmt9Formatter12debug_struct17h966f42198588d5ffE(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [11 x i8] }>* @alloc1241 to [0 x i8]*), i64 11)
  %.0..sroa_cast = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder to i128*
  store i128 %1, i128* %.0..sroa_cast, align 8
  %2 = bitcast %"distributions::uniform::UniformInt<u32>.258"** %_15 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %2)
  %3 = bitcast %"distributions::uniform::UniformInt<u32>.258"** %_15 to %"distributions::uniform::UniformChar.283"**
  store %"distributions::uniform::UniformChar.283"* %self, %"distributions::uniform::UniformChar.283"** %3, align 8
  %_12.0 = bitcast %"distributions::uniform::UniformInt<u32>.258"** %_15 to {}*
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %2)
  %4 = call zeroext i1 @_ZN4core3fmt8builders11DebugStruct6finish17h72e9687c51511b31E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder)
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %0)
  ret i1 %4
}

; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN82_$LT$rand..distributions..uniform..UniformDuration$u20$as$u20$core..fmt..Debug$GT$3fmt17h7b2cce9bbc108ae7E"(%"distributions::uniform::UniformDuration.284"* mpk_immut noalias readonly align 8 dereferenceable(48) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_24 = alloca i32*, align 8
  %_16 = alloca %"distributions::uniform::UniformDurationMode.259"*, align 8
  %debug_trait_builder = alloca %"core::fmt::DebugStruct.299", align 8
  %__self_0_1 = getelementptr inbounds %"distributions::uniform::UniformDuration.284", %"distributions::uniform::UniformDuration.284"* %self, i64 0, i32 3
  %0 = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %0)
  %1 = tail call i128 @_ZN4core3fmt9Formatter12debug_struct17h966f42198588d5ffE(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [15 x i8] }>* @alloc1243 to [0 x i8]*), i64 15)
  %.0..sroa_cast = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder to i128*
  store i128 %1, i128* %.0..sroa_cast, align 8
  %2 = bitcast %"distributions::uniform::UniformDurationMode.259"** %_16 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %2)
  %3 = bitcast %"distributions::uniform::UniformDurationMode.259"** %_16 to %"distributions::uniform::UniformDuration.284"**
  store %"distributions::uniform::UniformDuration.284"* %self, %"distributions::uniform::UniformDuration.284"** %3, align 8
  %_13.0 = bitcast %"distributions::uniform::UniformDurationMode.259"** %_16 to {}*
  %_9 = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [4 x i8] }>* @alloc1244 to [0 x i8]*), i64 4, {}* mpk_immut nonnull align 1 %_13.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (%"distributions::uniform::UniformDurationMode.259"**)*, i64, i64, i1 (%"distributions::uniform::UniformDurationMode.259"**, %"core::fmt::Formatter.253"*)* }* @vtable.a to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %2)
  %4 = bitcast i32** %_24 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %4)
  store i32* %__self_0_1, i32** %_24, align 8
  %_21.0 = bitcast i32** %_24 to {}*
  %_17 = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [6 x i8] }>* @alloc1245 to [0 x i8]*), i64 6, {}* mpk_immut nonnull align 1 %_21.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i32**)*, i64, i64, i1 (i32**, %"core::fmt::Formatter.253"*)* }* @vtable.1 to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %4)
  %5 = call zeroext i1 @_ZN4core3fmt8builders11DebugStruct6finish17h72e9687c51511b31E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder)
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %0)
  ret i1 %5
}

; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN86_$LT$rand..distributions..uniform..UniformDurationMode$u20$as$u20$core..fmt..Debug$GT$3fmt17h35ec28cf3936b898E"(%"distributions::uniform::UniformDurationMode.259"* mpk_immut noalias readonly align 8 dereferenceable(40) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_73 = alloca %"distributions::uniform::Uniform<u64>.260"*, align 8
  %_65 = alloca i32*, align 8
  %_57 = alloca i64*, align 8
  %debug_trait_builder2 = alloca %"core::fmt::DebugStruct.299", align 8
  %_41 = alloca %"distributions::uniform::Uniform<u64>.260"*, align 8
  %debug_trait_builder1 = alloca %"core::fmt::DebugStruct.299", align 8
  %_27 = alloca %"distributions::uniform::Uniform<u32>.261"*, align 8
  %_19 = alloca i64*, align 8
  %debug_trait_builder = alloca %"core::fmt::DebugStruct.299", align 8
  %0 = getelementptr inbounds %"distributions::uniform::UniformDurationMode.259", %"distributions::uniform::UniformDurationMode.259"* %self, i64 0, i32 0, i64 0
...
bb1:                                              ; preds = %start
  %__self_0 = getelementptr inbounds %"distributions::uniform::UniformDurationMode.259", %"distributions::uniform::UniformDurationMode.259"* %self, i64 0, i32 2, i64 1
  %2 = getelementptr inbounds %"distributions::uniform::UniformDurationMode.259", %"distributions::uniform::UniformDurationMode.259"* %self, i64 0, i32 2, i64 0
  %__self_2 = getelementptr inbounds %"distributions::uniform::UniformDurationMode.259", %"distributions::uniform::UniformDurationMode.259"* %self, i64 0, i32 2, i64 3
  %3 = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder2 to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %3)
  %4 = tail call i128 @_ZN4core3fmt9Formatter12debug_struct17h966f42198588d5ffE(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [5 x i8] }>* @alloc1246 to [0 x i8]*), i64 5)
  %.0..sroa_cast = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder2 to i128*
  ...
  %_50 = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder2, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [8 x i8] }>* @alloc1247 to [0 x i8]*), i64 8, {}* mpk_immut nonnull align 1 %_54.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i64**)*, i64, i64, i1 (i64**, %"core::fmt::Formatter.253"*)* }* @vtable.7 to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %5)
  %7 = bitcast i32** %_65 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %7)
  store i32* %2, i32** %_65, align 8
  %_62.0 = bitcast i32** %_65 to {}*
  %_58 = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder2, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [9 x i8] }>* @alloc1248 to [0 x i8]*), i64 9, {}* mpk_immut nonnull align 1 %_62.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i32**)*, i64, i64, i1 (i32**, %"core::fmt::Formatter.253"*)* }* @vtable.1 to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %7)
  %8 = bitcast %"distributions::uniform::Uniform<u64>.260"** %_73 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %8)
  %9 = bitcast %"distributions::uniform::Uniform<u64>.260"** %_73 to i32**
  store i32* %__self_2, i32** %9, align 8
  %_70.0 = bitcast %"distributions::uniform::Uniform<u64>.260"** %_73 to {}*
  %_66 = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder2, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [4 x i8] }>* @alloc1253 to [0 x i8]*), i64 4, {}* mpk_immut nonnull align 1 %_70.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (%"distributions::uniform::Uniform<u64>.260"**)*, i64, i64, i1 (%"distributions::uniform::Uniform<u64>.260"**, %"core::fmt::Formatter.253"*)* }* @vtable.b to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %8)
  %10 = call zeroext i1 @_ZN4core3fmt8builders11DebugStruct6finish17h72e9687c51511b31E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder2)
...
bb3:                                              ; preds = %start
  %__self_04 = getelementptr inbounds %"distributions::uniform::UniformDurationMode.259", %"distributions::uniform::UniformDurationMode.259"* %self, i64 0, i32 2, i64 3
  %__self_15 = getelementptr inbounds %"distributions::uniform::UniformDurationMode.259", %"distributions::uniform::UniformDurationMode.259"* %self, i64 0, i32 2
  %11 = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %11)
  %12 = tail call i128 @_ZN4core3fmt9Formatter12debug_struct17h966f42198588d5ffE(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [5 x i8] }>* @alloc1252 to [0 x i8]*), i64 5)
  %.0..sroa_cast19 = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder to i128*
  ...
  %_12 = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [4 x i8] }>* @alloc1253 to [0 x i8]*), i64 4, {}* mpk_immut nonnull align 1 %_16.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i64**)*, i64, i64, i1 (i64**, %"core::fmt::Formatter.253"*)* }* @vtable.7 to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %13)
  %15 = bitcast %"distributions::uniform::Uniform<u32>.261"** %_27 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %15)
  %16 = bitcast %"distributions::uniform::Uniform<u32>.261"** %_27 to [9 x i32]**
  store [9 x i32]* %__self_15, [9 x i32]** %16, align 8
  %_24.0 = bitcast %"distributions::uniform::Uniform<u32>.261"** %_27 to {}*
  %_20 = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [5 x i8] }>* @alloc1254 to [0 x i8]*), i64 5, {}* mpk_immut nonnull align 1 %_24.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (%"distributions::uniform::Uniform<u32>.261"**)*, i64, i64, i1 (%"distributions::uniform::Uniform<u32>.261"**, %"core::fmt::Formatter.253"*)* }* @vtable.c to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %15)
  %17 = call zeroext i1 @_ZN4core3fmt8builders11DebugStruct6finish17h72e9687c51511b31E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder)
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %11)
  br label %bb17

bb8:                                              ; preds = %start
  %__self_03 = getelementptr inbounds %"distributions::uniform::UniformDurationMode.259", %"distributions::uniform::UniformDurationMode.259"* %self, i64 0, i32 2, i64 1
  %18 = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %18)
  %19 = tail call i128 @_ZN4core3fmt9Formatter12debug_struct17h966f42198588d5ffE(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [6 x i8] }>* @alloc1250 to [0 x i8]*), i64 6)
  %.0..sroa_cast15 = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder1 to i128*
  store i128 %19, i128* %.0..sroa_cast15, align 8
  %20 = bitcast %"distributions::uniform::Uniform<u64>.260"** %_41 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %20)
  %21 = bitcast %"distributions::uniform::Uniform<u64>.260"** %_41 to i32**
  store i32* %__self_03, i32** %21, align 8
  %_38.0 = bitcast %"distributions::uniform::Uniform<u64>.260"** %_41 to {}*
  %_34 = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder1, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [5 x i8] }>* @alloc1254 to [0 x i8]*), i64 5, {}* mpk_immut nonnull align 1 %_38.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (%"distributions::uniform::Uniform<u64>.260"**)*, i64, i64, i1 (%"distributions::uniform::Uniform<u64>.260"**, %"core::fmt::Formatter.253"*)* }* @vtable.b to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %20)
  %22 = call zeroext i1 @_ZN4core3fmt8builders11DebugStruct6finish17h72e9687c51511b31E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder1)
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN66_$LT$rand..distributions..Standard$u20$as$u20$core..fmt..Debug$GT$3fmt17he69f939077e3ddfbE"(%"distributions::Standard.285"* mpk_immut noalias nocapture nonnull readonly align 1 %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %debug_trait_builder = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %0)
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN73_$LT$rand..rngs..adapter..read..ReadError$u20$as$u20$core..fmt..Debug$GT$3fmt17hf5037149fa09d779E"(%"rngs::adapter::read::ReadError.276"* mpk_immut noalias readonly align 8 dereferenceable(16) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_13 = alloca %"std::io::Error.256"*, align 8
  %debug_trait_builder = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %0)
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %debug_trait_builder, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [9 x i8] }>* @alloc1256 to [0 x i8]*), i64 9)
  %1 = bitcast %"std::io::Error.256"** %_13 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %1)
  %2 = bitcast %"std::io::Error.256"** %_13 to %"rngs::adapter::read::ReadError.276"**
  store %"rngs::adapter::read::ReadError.276"* %self, %"rngs::adapter::read::ReadError.276"** %2, align 8
  %_10.0 = bitcast %"std::io::Error.256"** %_13 to {}*
  %_8 = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder, {}* mpk_immut nonnull align 1 %_10.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (%"std::io::Error.256"**)*, i64, i64, i1 (%"std::io::Error.256"**, %"core::fmt::Formatter.253"*)* }* @vtable.d to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %1)
  %3 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %0)
  ret i1 %3
}

; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN62_$LT$rand..rngs..mock..StepRng$u20$as$u20$core..fmt..Debug$GT$3fmt17h8bb59a42cca057f3E"({ i64, i64 }* mpk_immut noalias readonly align 8 dereferenceable(16) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  ...
  %0 = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %0)
  %1 = tail call i128 @_ZN4core3fmt9Formatter12debug_struct17h966f42198588d5ffE(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [7 x i8] }>* @alloc1257 to [0 x i8]*), i64 7)
  %.0..sroa_cast = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder to i128*
  store i128 %1, i128* %.0..sroa_cast, align 8
  ...
  %_9 = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [1 x i8] }>* @alloc1258 to [0 x i8]*), i64 1, {}* mpk_immut nonnull align 1 %_13.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i64**)*, i64, i64, i1 (i64**, %"core::fmt::Formatter.253"*)* }* @vtable.7 to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %2)
  %3 = bitcast i64** %_24 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %3)
  store i64* %__self_0_1, i64** %_24, align 8
  %_21.0 = bitcast i64** %_24 to {}*
  %_17 = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [1 x i8] }>* @alloc1259 to [0 x i8]*), i64 1, {}* mpk_immut nonnull align 1 %_21.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i64**)*, i64, i64, i1 (i64**, %"core::fmt::Formatter.253"*)* }* @vtable.7 to [3 x i64]*))
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN60_$LT$rand..rngs..std..StdRng$u20$as$u20$core..fmt..Debug$GT$3fmt17h1e71c1e3211e7133E"(%"rngs::std::StdRng.286"* mpk_immut noalias readonly align 16 dereferenceable(320) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_13 = alloca %"rand_chacha::ChaCha12Rng.267"*, align 8
  %debug_trait_builder = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %0)
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %debug_trait_builder, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [6 x i8] }>* @alloc1260 to [0 x i8]*), i64 6)
  %1 = bitcast %"rand_chacha::ChaCha12Rng.267"** %_13 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %1)
  %2 = bitcast %"rand_chacha::ChaCha12Rng.267"** %_13 to %"rngs::std::StdRng.286"**
  store %"rngs::std::StdRng.286"* %self, %"rngs::std::StdRng.286"** %2, align 8
  %_10.0 = bitcast %"rand_chacha::ChaCha12Rng.267"** %_13 to {}*
  %_8 = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder, {}* mpk_immut nonnull align 1 %_10.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (%"rand_chacha::ChaCha12Rng.267"**)*, i64, i64, i1 (%"rand_chacha::ChaCha12Rng.267"**, %"core::fmt::Formatter.253"*)* }* @vtable.e to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %1)
  %3 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %0)
  ret i1 %3
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN66_$LT$rand..rngs..thread..ThreadRng$u20$as$u20$core..fmt..Debug$GT$3fmt17h436f840fb66acbbaE"(i64** mpk_immut noalias readonly align 8 dereferenceable(8) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_15 = alloca i64**, align 8, !MPK-SmartPointer !219
  %debug_trait_builder = alloca %"core::fmt::DebugStruct.299", align 8
  %0 = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %0)
  %1 = tail call i128 @_ZN4core3fmt9Formatter12debug_struct17h966f42198588d5ffE(%"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [9 x i8] }>* @alloc1261 to [0 x i8]*), i64 9)
  %.0..sroa_cast = bitcast %"core::fmt::DebugStruct.299"* %debug_trait_builder to i128*
  store i128 %1, i128* %.0..sroa_cast, align 8
  %2 = bitcast i64*** %_15 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %2)
  store i64** %self, i64*** %_15, align 8
  %_12.0 = bitcast i64*** %_15 to {}*
  %_8 = call align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [3 x i8] }>* @alloc1262 to [0 x i8]*), i64 3, {}* mpk_immut nonnull align 1 %_12.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (i64***)*, i64, i64, i1 (i64***, %"core::fmt::Formatter.253"*)* }* @vtable.f to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %2)
  %3 = call zeroext i1 @_ZN4core3fmt8builders11DebugStruct6finish17h72e9687c51511b31E(%"core::fmt::DebugStruct.299"* nonnull align 8 dereferenceable(16) %debug_trait_builder)
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %0)
  ret i1 %3
...
define internal fastcc void @"_ZN4rand4rngs6thread14THREAD_RNG_KEY6__init28_$u7b$$u7b$closure$u7d$$u7d$17hf0f35f3310f60052E"(i8* mpk_immut noalias nonnull align 1 %0, i64* mpk_immut noalias readonly align 8 dereferenceable(24) %1) unnamed_addr #8 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"*, %"unwind::libunwind::_Unwind_Context.291"*)* @rust_eh_personality {
bb2:
  %_10 = alloca [1 x { i8*, i64* }], align 8
  %_3 = alloca %"core::fmt::Arguments.297", align 8
  ...
  %4 = bitcast %"core::fmt::Arguments.297"* %_3 to i8*
  ...
  store i64* bitcast (i1 ({ i8*, i64* }*, %"core::fmt::Formatter.253"*)* @"_ZN62_$LT$rand_core..error..Error$u20$as$u20$core..fmt..Display$GT$3fmt17hc86c94beba41deb1E" to i64*), i64** %7, align 8
  %8 = bitcast %"core::fmt::Arguments.297"* %_3 to [0 x { [0 x i8]*, i64 }]**
  store [0 x { [0 x i8]*, i64 }]* bitcast (<{ i8*, [8 x i8] }>* @alloc995 to [0 x { [0 x i8]*, i64 }]*), [0 x { [0 x i8]*, i64 }]** %8, align 8, !alias.scope !220, !noalias !223
  %9 = getelementptr inbounds %"core::fmt::Arguments.297", %"core::fmt::Arguments.297"* %_3, i64 0, i32 1, i32 1
  store i64 1, i64* %9, align 8, !alias.scope !220, !noalias !223
  %10 = getelementptr inbounds %"core::fmt::Arguments.297", %"core::fmt::Arguments.297"* %_3, i64 0, i32 3, i32 0
  store i64* null, i64** %10, align 8, !alias.scope !220, !noalias !223
  %11 = getelementptr inbounds %"core::fmt::Arguments.297", %"core::fmt::Arguments.297"* %_3, i64 0, i32 5, i32 0
  %12 = bitcast [0 x { i8*, i64* }]** %11 to [1 x { i8*, i64* }]**
  store [1 x { i8*, i64* }]* %_10, [1 x { i8*, i64* }]** %12, align 8, !alias.scope !220, !noalias !223
  %13 = getelementptr inbounds %"core::fmt::Arguments.297", %"core::fmt::Arguments.297"* %_3, i64 0, i32 5, i32 1
  store i64 1, i64* %13, align 8, !alias.scope !220, !noalias !223
  invoke void @_ZN4core9panicking9panic_fmt17h08461824ca4df3e0E(%"core::fmt::Arguments.297"* noalias nocapture nonnull dereferenceable(48) %_3, %"core::panic::Location.289"* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast (<{ i8*, [16 x i8] }>* @alloc1264 to %"core::panic::Location.289"*))
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN63_$LT$rand..seq..index..IndexVec$u20$as$u20$core..fmt..Debug$GT$3fmt17h6fc353a0314ec676E"(%"seq::index::IndexVec.279"* mpk_immut noalias readonly align 8 dereferenceable(32) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_28 = alloca %"std::vec::Vec<usize>.268"*, align 8, !MPK-SmartPointer !219
  %debug_trait_builder1 = alloca %"core::fmt::DebugTuple.298", align 8
  %_16 = alloca %"std::vec::Vec<u32>.269"*, align 8, !MPK-SmartPointer !219
  %debug_trait_builder = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = getelementptr inbounds %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %self, i64 0, i32 0, i64 0
  %_5 = load i64, i64* %0, align 8, !range !153
  %switch.not = icmp eq i64 %_5, 1
  %__self_0 = getelementptr inbounds %"seq::index::IndexVec.279", %"seq::index::IndexVec.279"* %self, i64 0, i32 2
  br i1 %switch.not, label %bb1, label %bb3

bb1:                                              ; preds = %start
  %1 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder1 to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %1)
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %debug_trait_builder1, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [5 x i8] }>* @alloc1269 to [0 x i8]*), i64 5)
  %2 = bitcast %"std::vec::Vec<usize>.268"** %_28 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %2)
  %3 = bitcast %"std::vec::Vec<usize>.268"** %_28 to [3 x i64]**
  store [3 x i64]* %__self_0, [3 x i64]** %3, align 8
  %_25.0 = bitcast %"std::vec::Vec<usize>.268"** %_28 to {}*
  %_23 = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder1, {}* mpk_immut nonnull align 1 %_25.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (%"std::vec::Vec<usize>.268"**)*, i64, i64, i1 (%"std::vec::Vec<usize>.268"**, %"core::fmt::Formatter.253"*)* }* @vtable.g to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %2)
  %4 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder1)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %1)
  br label %bb10

bb3:                                              ; preds = %start
  %5 = bitcast %"core::fmt::DebugTuple.298"* %debug_trait_builder to i8*
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %5)
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %debug_trait_builder, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [3 x i8] }>* @alloc1270 to [0 x i8]*), i64 3)
  %6 = bitcast %"std::vec::Vec<u32>.269"** %_16 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %6)
  %7 = bitcast %"std::vec::Vec<u32>.269"** %_16 to [3 x i64]**
  store [3 x i64]* %__self_0, [3 x i64]** %7, align 8
  %_13.0 = bitcast %"std::vec::Vec<u32>.269"** %_16 to {}*
  %_11 = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder, {}* mpk_immut nonnull align 1 %_13.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (%"std::vec::Vec<u32>.269"**)*, i64, i64, i1 (%"std::vec::Vec<u32>.269"**, %"core::fmt::Formatter.253"*)* }* @vtable.h to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %6)
  %8 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %5)
  br label %bb10
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN67_$LT$rand..seq..index..IndexVecIter$u20$as$u20$core..fmt..Debug$GT$3fmt17he732390c7ae0d4ebE"(%"seq::index::IndexVecIter.287"* mpk_immut noalias readonly align 8 dereferenceable(24) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_28 = alloca { i64*, i64* }*, align 8
  %debug_trait_builder1 = alloca %"core::fmt::DebugTuple.298", align 8
  %_16 = alloca { i32*, i32* }*, align 8
  %debug_trait_builder = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = getelementptr inbounds %"seq::index::IndexVecIter.287", %"seq::index::IndexVecIter.287"* %self, i64 0, i32 0, i64 0
  %_5 = load i64, i64* %0, align 8, !range !153
  %switch.not = icmp eq i64 %_5, 1
  %__self_0 = getelementptr inbounds %"seq::index::IndexVecIter.287", %"seq::index::IndexVecIter.287"* %self, i64 0, i32 2
  br i1 %switch.not, label %bb1, label %bb3
...
bb1:                                              ; preds = %start
  ...
  %_23 = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder1, {}* mpk_immut nonnull align 1 %_25.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void ({ i64*, i64* }**)*, i64, i64, i1 ({ i64*, i64* }**, %"core::fmt::Formatter.253"*)* }* @vtable.i to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %2)
  %4 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder1)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %1)
  br label %bb10
...
bb3:                                              ; preds = %start
  ...
  %_11 = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder, {}* mpk_immut nonnull align 1 %_13.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void ({ i32*, i32* }**)*, i64, i64, i1 ({ i32*, i32* }**, %"core::fmt::Formatter.253"*)* }* @vtable.j to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %6)
  %8 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %5)
  br label %bb10
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN71_$LT$rand..seq..index..IndexVecIntoIter$u20$as$u20$core..fmt..Debug$GT$3fmt17he531da83a9fc938eE"(%"seq::index::IndexVecIntoIter.288"* mpk_immut noalias readonly align 8 dereferenceable(40) %self, %"core::fmt::Formatter.253"* align 8 dereferenceable(64) %f) unnamed_addr #0 {
start:
  %_28 = alloca %"std::vec::IntoIter<usize>.271"*, align 8, !MPK-SmartPointer !219
  %debug_trait_builder1 = alloca %"core::fmt::DebugTuple.298", align 8
  %_16 = alloca %"std::vec::IntoIter<u32>.273"*, align 8, !MPK-SmartPointer !219
  %debug_trait_builder = alloca %"core::fmt::DebugTuple.298", align 8
  %0 = getelementptr inbounds %"seq::index::IndexVecIntoIter.288", %"seq::index::IndexVecIntoIter.288"* %self, i64 0, i32 0, i64 0
  %_5 = load i64, i64* %0, align 8, !range !153
  %switch.not = icmp eq i64 %_5, 1
  %__self_0 = getelementptr inbounds %"seq::index::IndexVecIntoIter.288", %"seq::index::IndexVecIntoIter.288"* %self, i64 0, i32 2
  br i1 %switch.not, label %bb1, label %bb3
...
bb1:                                              ; preds = %start
  ...
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %1)
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %debug_trait_builder1, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [5 x i8] }>* @alloc1269 to [0 x i8]*), i64 5)
  %2 = bitcast %"std::vec::IntoIter<usize>.271"** %_28 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %2)
  %3 = bitcast %"std::vec::IntoIter<usize>.271"** %_28 to [4 x i64]**
  store [4 x i64]* %__self_0, [4 x i64]** %3, align 8
  %_25.0 = bitcast %"std::vec::IntoIter<usize>.271"** %_28 to {}*
  %_23 = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder1, {}* mpk_immut nonnull align 1 %_25.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (%"std::vec::IntoIter<usize>.271"**)*, i64, i64, i1 (%"std::vec::IntoIter<usize>.271"**, %"core::fmt::Formatter.253"*)* }* @vtable.k to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %2)
  %4 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder1)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %1)
  br label %bb10
...
bb3:                                              ; preds = %start
  ...
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %5)
  call void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture nonnull sret dereferenceable(24) %debug_trait_builder, %"core::fmt::Formatter.253"* nonnull align 8 dereferenceable(64) %f, [0 x i8]* mpk_immut noalias nonnull readonly align 1 bitcast (<{ [3 x i8] }>* @alloc1270 to [0 x i8]*), i64 3)
  %6 = bitcast %"std::vec::IntoIter<u32>.273"** %_16 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %6)
  %7 = bitcast %"std::vec::IntoIter<u32>.273"** %_16 to [4 x i64]**
  store [4 x i64]* %__self_0, [4 x i64]** %7, align 8
  %_13.0 = bitcast %"std::vec::IntoIter<u32>.273"** %_16 to {}*
  %_11 = call align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder, {}* mpk_immut nonnull align 1 %_13.0, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24) bitcast ({ void (%"std::vec::IntoIter<u32>.273"**)*, i64, i64, i1 (%"std::vec::IntoIter<u32>.273"**, %"core::fmt::Formatter.253"*)* }* @vtable.l to [3 x i64]*))
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %6)
  %8 = call zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* nonnull align 8 dereferenceable(24) %debug_trait_builder)
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %5)
  br label %bb10
...
declare void @_ZN4core5slice5index26slice_start_index_len_fail17h2ad4471ff7be2fa2E(i64, i64, %"core::panic::Location.289"* mpk_immut noalias readonly align 8 dereferenceable(24)) unnamed_addr #10

; Function Attrs: mpk_extern nounwind nonlazybind uwtable
declare i32 @rust_eh_personality(i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.290"* mpk_unsafe, %"unwind::libunwind::_Unwind_Context.291"* mpk_unsafe) unnamed_addr #3

; Function Attrs: nonlazybind uwtable
declare void @_ZN11rand_chacha4guts11init_chacha17h5a24505c0c6e62e9E(%"rand_chacha::guts::ChaCha.264"* noalias nocapture sret dereferenceable(48), [32 x i8]* mpk_immut noalias readonly align 1 dereferenceable(32), [0 x i8]* mpk_immut noalias nonnull readonly align 1, i64) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare void @_ZN11rand_chacha4guts11refill_wide17hd8b631cf1edebeabE(%"rand_chacha::guts::ChaCha.264"* align 16 dereferenceable(48), i32, [256 x i8]* align 1 dereferenceable(256)) unnamed_addr #0

; Function Attrs: cold nonlazybind uwtable
declare void @_ZN3std4sync4once4Once10call_inner17hddcf8ee610748361E(%"std::sync::Once.294"* mpk_immut align 8 dereferenceable(8), i1 zeroext, {}* nonnull align 1, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24)) unnamed_addr #11
...
; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN69_$LT$rand_chacha..chacha..ChaCha12Rng$u20$as$u20$core..fmt..Debug$GT$3fmt17h0c2da16597097293E"(%"rand_chacha::ChaCha12Rng.267"* mpk_immut noalias readonly align 16 dereferenceable(320), %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN58_$LT$std..io..error..Error$u20$as$u20$core..fmt..Debug$GT$3fmt17h92bc210ff9abc8b7E"(%"std::io::Error.256"* mpk_immut noalias readonly align 8 dereferenceable(16), %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare i128 @_ZN4core3fmt9Formatter10debug_list17h8147fa4f8cb43178E(%"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: argmemonly nounwind willreturn
declare void @llvm.memcpy.p0i8.p0i8.i64(i8* noalias nocapture writeonly, i8* noalias nocapture readonly, i64, i1 immarg) #9

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @_ZN4core3fmt8builders9DebugList6finish17h1110a7134d6ce275E(%"core::fmt::DebugList.296"* align 8 dereferenceable(16)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @_ZN4core3fmt9Formatter15debug_lower_hex17h6ddb5559176c6045E(%"core::fmt::Formatter.253"* mpk_immut noalias readonly align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN4core3fmt3num53_$LT$impl$u20$core..fmt..LowerHex$u20$for$u20$u32$GT$3fmt17hbdab60765508c6f3E"(i32* mpk_immut noalias readonly align 4 dereferenceable(4), %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @_ZN4core3fmt9Formatter15debug_upper_hex17h61a2e870dc3af9acE(%"core::fmt::Formatter.253"* mpk_immut noalias readonly align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN4core3fmt3num53_$LT$impl$u20$core..fmt..UpperHex$u20$for$u20$u32$GT$3fmt17h4773017a326a508bE"(i32* mpk_immut noalias readonly align 4 dereferenceable(4), %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN4core3fmt3num3imp52_$LT$impl$u20$core..fmt..Display$u20$for$u20$u32$GT$3fmt17h6b8b41e24df1a43fE"(i32* mpk_immut noalias readonly align 4 dereferenceable(4), %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN4core3fmt3num53_$LT$impl$u20$core..fmt..LowerHex$u20$for$u20$u64$GT$3fmt17he9d3331e4e8b2618E"(i64* mpk_immut noalias readonly align 8 dereferenceable(8), %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN4core3fmt3num53_$LT$impl$u20$core..fmt..UpperHex$u20$for$u20$u64$GT$3fmt17h46c4aab50ded2d21E"(i64* mpk_immut noalias readonly align 8 dereferenceable(8), %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN4core3fmt3num3imp52_$LT$impl$u20$core..fmt..Display$u20$for$u20$u64$GT$3fmt17h4dc2af1a5829180dE"(i64* mpk_immut noalias readonly align 8 dereferenceable(8), %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN4core3fmt3num55_$LT$impl$u20$core..fmt..LowerHex$u20$for$u20$usize$GT$3fmt17h3fb07f7e6da8e1c6E"(i64* mpk_immut noalias readonly align 8 dereferenceable(8), %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN4core3fmt3num55_$LT$impl$u20$core..fmt..UpperHex$u20$for$u20$usize$GT$3fmt17hf3a9e839be306c07E"(i64* mpk_immut noalias readonly align 8 dereferenceable(8), %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN4core3fmt3num3imp54_$LT$impl$u20$core..fmt..Display$u20$for$u20$usize$GT$3fmt17h0f57e3373191c50eE"(i64* mpk_immut noalias readonly align 8 dereferenceable(8), %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare align 8 dereferenceable(16) %"core::fmt::DebugList.296"* @_ZN4core3fmt8builders9DebugList5entry17h65db77502f12805cE(%"core::fmt::DebugList.296"* align 8 dereferenceable(16), {}* mpk_immut nonnull align 1, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24)) unnamed_addr #0

; Function Attrs: cold noinline noreturn nonlazybind uwtable
declare void @_ZN4core9panicking5panic17hc14ab8d72efd34afE([0 x i8]* mpk_immut noalias nonnull readonly align 1, i64, %"core::panic::Location.289"* mpk_immut noalias readonly align 8 dereferenceable(24)) unnamed_addr #10

; Function Attrs: cold noinline noreturn nonlazybind uwtable
declare void @_ZN4core9panicking9panic_fmt17h08461824ca4df3e0E(%"core::fmt::Arguments.297"* noalias nocapture dereferenceable(48), %"core::panic::Location.289"* mpk_immut noalias readonly align 8 dereferenceable(24)) unnamed_addr #10

; Function Attrs: nounwind willreturn
declare void @llvm.assume(i1) #12

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN68_$LT$std..thread..local..AccessError$u20$as$u20$core..fmt..Debug$GT$3fmt17ha315f601bcb7816fE"(%"std::thread::AccessError.254"* mpk_immut noalias nonnull readonly align 1, %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: cold noinline noreturn nonlazybind uwtable
declare void @_ZN4core6result13unwrap_failed17hf1bf530e85f5bb70E([0 x i8]* mpk_immut noalias nonnull readonly align 1, i64, {}* mpk_immut nonnull align 1, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24), %"core::panic::Location.289"* mpk_immut noalias readonly align 8 dereferenceable(24)) unnamed_addr #10

; Function Attrs: nonlazybind uwtable
declare { i8*, i8* } @"_ZN59_$LT$rand_core..os..OsRng$u20$as$u20$rand_core..RngCore$GT$14try_fill_bytes17hd80590ef176c258cE"(%"rand_core::OsRng.277"* nonnull align 1, [0 x i8]* nonnull align 1, i64) unnamed_addr #0
...
; Function Attrs: nonlazybind uwtable
declare void @_ZN4core3fmt9Formatter11debug_tuple17had636d1c61c1720cE(%"core::fmt::DebugTuple.298"* noalias nocapture sret dereferenceable(24), %"core::fmt::Formatter.253"* align 8 dereferenceable(64), [0 x i8]* mpk_immut noalias nonnull readonly align 1, i64) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare align 8 dereferenceable(24) %"core::fmt::DebugTuple.298"* @_ZN4core3fmt8builders10DebugTuple5field17he382aec0d37198f2E(%"core::fmt::DebugTuple.298"* align 8 dereferenceable(24), {}* mpk_immut nonnull align 1, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @_ZN4core3fmt8builders10DebugTuple6finish17hfb7845347804f609E(%"core::fmt::DebugTuple.298"* align 8 dereferenceable(24)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @_ZN4core3fmt9Formatter3pad17h77c5e3cc34c58830E(%"core::fmt::Formatter.253"* align 8 dereferenceable(64), [0 x i8]* mpk_immut noalias nonnull readonly align 1, i64) unnamed_addr #0
...
; Function Attrs: nonlazybind uwtable
declare zeroext i1 @_ZN4core3fmt9Formatter9write_str17hdd0117a4487b56c4E(%"core::fmt::Formatter.253"* align 8 dereferenceable(64), [0 x i8]* mpk_immut noalias nonnull readonly align 1, i64) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @_ZN4core3fmt9Formatter9write_fmt17h767ce03da9bc508fE(%"core::fmt::Formatter.253"* align 8 dereferenceable(64), %"core::fmt::Arguments.297"* noalias nocapture dereferenceable(48)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN60_$LT$std..io..error..Error$u20$as$u20$core..fmt..Display$GT$3fmt17ha444a7daee083529E"(%"std::io::Error.256"* mpk_immut noalias readonly align 8 dereferenceable(16), %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare { i8*, i8* } @"_ZN59_$LT$std..io..error..Error$u20$as$u20$std..error..Error$GT$6source17h58eb92854d84e79fE"(%"std::io::Error.256"* mpk_immut noalias readonly align 8 dereferenceable(16)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare { [0 x i8]*, i64 } @"_ZN59_$LT$std..io..error..Error$u20$as$u20$std..error..Error$GT$11description17hdc6ea995e10d5d20E"(%"std::io::Error.256"* mpk_immut noalias readonly align 8 dereferenceable(16)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare { i8*, i8* } @"_ZN59_$LT$std..io..error..Error$u20$as$u20$std..error..Error$GT$5cause17h1043acf78dfb3752E"(%"std::io::Error.256"* mpk_immut noalias readonly align 8 dereferenceable(16)) unnamed_addr #0

; Function Attrs: mpk_extern nounwind nonlazybind uwtable
declare i32 @pthread_atfork(i64* mpk_immut, i64* mpk_immut, i64* mpk_immut) unnamed_addr #3

; Function Attrs: nonlazybind uwtable
declare i128 @_ZN4core3fmt9Formatter12debug_struct17h966f42198588d5ffE(%"core::fmt::Formatter.253"* align 8 dereferenceable(64), [0 x i8]* mpk_immut noalias nonnull readonly align 1, i64) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare align 8 dereferenceable(16) %"core::fmt::DebugStruct.299"* @_ZN4core3fmt8builders11DebugStruct5field17h0ff9ad91302e7217E(%"core::fmt::DebugStruct.299"* align 8 dereferenceable(16), [0 x i8]* mpk_immut noalias nonnull readonly align 1, i64, {}* mpk_immut nonnull align 1, [3 x i64]* mpk_immut noalias readonly align 8 dereferenceable(24)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @_ZN4core3fmt8builders11DebugStruct6finish17h72e9687c51511b31E(%"core::fmt::DebugStruct.299"* align 8 dereferenceable(16)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare zeroext i1 @"_ZN62_$LT$rand_core..error..Error$u20$as$u20$core..fmt..Display$GT$3fmt17hc86c94beba41deb1E"({ i8*, i64* }* mpk_immut noalias readonly align 8 dereferenceable(16), %"core::fmt::Formatter.253"* align 8 dereferenceable(64)) unnamed_addr #0
