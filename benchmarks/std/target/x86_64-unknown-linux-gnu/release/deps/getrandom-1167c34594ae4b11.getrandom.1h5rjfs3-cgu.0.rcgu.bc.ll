...
%"unwind::libunwind::_Unwind_Exception.10" = type { [0 x i64], i64, [0 x i64], void (i32, %"unwind::libunwind::_Unwind_Exception.10"*)*, [0 x i64], [6 x i64], [0 x i64] }
%"unwind::libunwind::_Unwind_Context.11" = type { [0 x i8] }
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN60_$LT$getrandom..error..Error$u20$as$u20$core..fmt..Debug$GT$3fmt17hbc66eb07f2bd9a73E"(i32* mpk_immut noalias nocapture readonly align 4 dereferenceable(4) %self, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f) unnamed_addr #1 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.10"*, %"unwind::libunwind::_Unwind_Context.11"*)* @rust_eh_personality {
start:
...
; Function Attrs: nonlazybind uwtable
define zeroext i1 @"_ZN62_$LT$getrandom..error..Error$u20$as$u20$core..fmt..Display$GT$3fmt17h232ed3a0cf84905dE"(i32* mpk_immut noalias nocapture readonly align 4 dereferenceable(4) %self, %"core::fmt::Formatter"* align 8 dereferenceable(64) %f) unnamed_addr #1 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.10"*, %"unwind::libunwind::_Unwind_Context.11"*)* @rust_eh_personality {
start:
  %_20.i = alloca %"core::result::Result<&str, core::str::Utf8Error>", align 8
...
; Function Attrs: nonlazybind uwtable
define i32 @_ZN9getrandom9getrandom17hcef438c5cd6a7b2bE([0 x i8]* nonnull align 1 %dest.0, i64 %dest.1) unnamed_addr #1 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.10"*, %"unwind::libunwind::_Unwind_Context.11"*)* @rust_eh_personality {
start:
...
bb5.i.i.i:                                        ; preds = %bb2.i
  %r.i.i.i.i = tail call i32 @pthread_mutex_lock(%"libc::pthread_mutex_t"* mpk_unsafe bitcast (<{ [40 x i8] }>* @_ZN9getrandom8use_file10get_rng_fd5MUTEX17hc60dd9de71208b09E to %"libc::pthread_mutex_t"*)) #12, !MPK-Unsafe !5
...
bb22.i.i.i:                                       ; preds = %bb10.i.i.i
  ...
  %r.i.i.i.i48.i.i.i = call i32 @pthread_mutex_unlock(%"libc::pthread_mutex_t"* mpk_unsafe bitcast (<{ [40 x i8] }>* @_ZN9getrandom8use_file10get_rng_fd5MUTEX17hc60dd9de71208b09E to %"libc::pthread_mutex_t"*)) #12, !MPK-Unsafe !5
...
_ZN9getrandom8use_file10get_rng_fd17h9e1de31e8adbde52E.exit.i.thread.i: ; preds = %bb21.i.i.i, %bb9.i.i.i, %bb5.i.i.i.i
  ...
  %r.i.i.i.i.i.i29.i = call i32 @pthread_mutex_unlock(%"libc::pthread_mutex_t"* mpk_unsafe bitcast (<{ [40 x i8] }>* @_ZN9getrandom8use_file10get_rng_fd5MUTEX17hc60dd9de71208b09E to %"libc::pthread_mutex_t"*)) #12, !MPK-Unsafe !5
  br label %bb5

_ZN9getrandom8use_file10get_rng_fd17h9e1de31e8adbde52E.exit.i.i: ; preds = %bb5.i.i.i
  %_6.i46.i.i.i = trunc i64 %6 to i32
  %r.i.i.i.i.i.i.i = tail call i32 @pthread_mutex_unlock(%"libc::pthread_mutex_t"* mpk_unsafe bitcast (<{ [40 x i8] }>* @_ZN9getrandom8use_file10get_rng_fd5MUTEX17hc60dd9de71208b09E to %"libc::pthread_mutex_t"*)) #12, !MPK-Unsafe !5
  br label %bb3.i.i.sink.split, !MPK-Unsafe2 !40
...
declare i32 @rust_eh_personality(i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.10"* mpk_unsafe, %"unwind::libunwind::_Unwind_Context.11"* mpk_unsafe) unnamed_addr #9
