...
define internal fastcc void @_ZN3std10sys_common9backtrace28__rust_begin_short_backtrace17hc4da26f36014bcf8E(void ()* mpk_immut nocapture nonnull %f) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.0"*, %"unwind::libunwind::_Unwind_Context.1"*)* @rust_eh_personality {
start:
...
; Function Attrs: nonlazybind uwtable
define internal i32 @"_ZN4core3ops8function6FnOnce40call_once$u7b$$u7b$vtable.shim$u7d$$u7d$17h18fc0dfeb0150306E"(i64** nocapture readonly %_1) unnamed_addr #1 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.0"*, %"unwind::libunwind::_Unwind_Context.1"*)* @rust_eh_personality {
start:
  %0 = bitcast i64** %_1 to void ()**
...
declare i32 @rust_eh_personality(i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.0"* mpk_unsafe, %"unwind::libunwind::_Unwind_Context.1"* mpk_unsafe) unnamed_addr #3
