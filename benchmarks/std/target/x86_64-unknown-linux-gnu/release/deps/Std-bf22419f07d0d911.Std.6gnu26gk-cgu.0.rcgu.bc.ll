...
%"test::TestDescAndFn.9" = type { [0 x i64], %"test::TestDesc.7", [0 x i64], %"test::TestFn.8", [0 x i64] }
%"test::TestDesc.7" = type { [0 x i64], %"test::TestName.5", [0 x i64], %"test::ShouldPanic.6", [0 x i8], i8, [0 x i8], i8, [0 x i8], i8, [5 x i8] }
%"test::TestName.5" = type { [0 x i8], i8, [39 x i8] }
%"test::ShouldPanic.6" = type { [0 x i64], i64, [2 x i64] }
%"test::TestFn.8" = type { [0 x i64], i64, [2 x i64] }
...
define internal fastcc void @_ZN3std10sys_common9backtrace28__rust_begin_short_backtrace17hc3c20b20e2a28828E(void ()* mpk_immut nocapture nonnull %f) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.3"*, %"unwind::libunwind::_Unwind_Context.4"*)* @rust_eh_personality {
start:
...
; Function Attrs: nonlazybind uwtable
define internal i32 @"_ZN4core3ops8function6FnOnce40call_once$u7b$$u7b$vtable.shim$u7d$$u7d$17h08320d5641c602b6E"(i64** nocapture readonly %_1) unnamed_addr #1 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.3"*, %"unwind::libunwind::_Unwind_Context.4"*)* @rust_eh_personality {
start:
  %0 = bitcast i64** %_1 to void ()**
...
start:
  tail call void @_ZN4test16test_main_static17he2b7f64da3b556c7E([0 x %"test::TestDescAndFn.9"*]* mpk_immut noalias nonnull readonly align 8 bitcast (<{ [0 x i8] }>* @alloc1 to [0 x %"test::TestDescAndFn.9"*]*), i64 0)
  ret void
}

; Function Attrs: mpk_extern nounwind nonlazybind uwtable
declare i32 @rust_eh_personality(i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.3"* mpk_unsafe, %"unwind::libunwind::_Unwind_Context.4"* mpk_unsafe) unnamed_addr #3
...
; Function Attrs: nonlazybind uwtable
declare void @_ZN4test16test_main_static17he2b7f64da3b556c7E([0 x %"test::TestDescAndFn.9"*]* mpk_immut noalias nonnull readonly align 8, i64) unnamed_addr #1
