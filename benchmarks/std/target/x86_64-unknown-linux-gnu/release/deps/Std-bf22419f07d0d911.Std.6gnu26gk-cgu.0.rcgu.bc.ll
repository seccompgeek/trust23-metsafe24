; ModuleID = '/home/martin/projects/metasafe/trust/benchmarks/std/target/x86_64-unknown-linux-gnu/release/deps/Std-bf22419f07d0d911.Std.6gnu26gk-cgu.0.rcgu.bc'
source_filename = "Std.6gnu26gk-cgu.0"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%"test::TestDescAndFn.88" = type { [0 x i64], %"test::TestDesc.86", [0 x i64], %"test::TestFn.87", [0 x i64] }
%"test::TestDesc.86" = type { [0 x i64], %"test::TestName.84", [0 x i64], %"test::ShouldPanic.85", [0 x i8], i8, [0 x i8], i8, [0 x i8], i8, [5 x i8] }
%"test::TestName.84" = type { [0 x i8], i8, [39 x i8] }
%"test::ShouldPanic.85" = type { [0 x i64], i64, [2 x i64] }
%"test::TestFn.87" = type { [0 x i64], i64, [2 x i64] }
%"unwind::libunwind::_Unwind_Exception.82" = type { [0 x i64], i64, [0 x i64], void (i32, %"unwind::libunwind::_Unwind_Exception.82"*)*, [0 x i64], [6 x i64], [0 x i64] }
%"unwind::libunwind::_Unwind_Context.83" = type { [0 x i8] }
...
define internal fastcc void @_ZN3std10sys_common9backtrace28__rust_begin_short_backtrace17hc3c20b20e2a28828E(void ()* mpk_immut nocapture nonnull %f) unnamed_addr #0 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.82"*, %"unwind::libunwind::_Unwind_Context.83"*)* @rust_eh_personality {
start:
...
; Function Attrs: nonlazybind uwtable
define internal i32 @"_ZN4core3ops8function6FnOnce40call_once$u7b$$u7b$vtable.shim$u7d$$u7d$17h08320d5641c602b6E"(i64** nocapture readonly %_1) unnamed_addr #1 personality i32 (i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.82"*, %"unwind::libunwind::_Unwind_Context.83"*)* @rust_eh_personality {
start:
  %0 = bitcast i64** %_1 to void ()**
...
start:
  tail call void @_ZN4test16test_main_static17he2b7f64da3b556c7E([0 x %"test::TestDescAndFn.88"*]* mpk_immut noalias nonnull readonly align 8 bitcast (<{ [0 x i8] }>* @alloc1 to [0 x %"test::TestDescAndFn.88"*]*), i64 0)
  ret void
}

; Function Attrs: mpk_extern nounwind nonlazybind uwtable
declare i32 @rust_eh_personality(i32, i32, i64, %"unwind::libunwind::_Unwind_Exception.82"* mpk_unsafe, %"unwind::libunwind::_Unwind_Context.83"* mpk_unsafe) unnamed_addr #3
...
; Function Attrs: nonlazybind uwtable
declare void @_ZN4test16test_main_static17he2b7f64da3b556c7E([0 x %"test::TestDescAndFn.88"*]* mpk_immut noalias nonnull readonly align 8, i64) unnamed_addr #1
