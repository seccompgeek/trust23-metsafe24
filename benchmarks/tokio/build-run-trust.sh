...
$BENCH_HOME/../../mpk-svf/Release-build/bin/dvf -cxt -max-cxt=1 -flow-bg=10 -field-limit=0 -cxt-bg=10 -query metasafe $(find $BENCH_HOME/target/x86_64-unknown-linux-gnu/release/deps -name '*.bc')
