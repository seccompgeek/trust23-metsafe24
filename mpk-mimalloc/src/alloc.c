...
mi_decl_nodiscard extern inline mi_decl_restrict void* mi_malloc_small(size_t size) mi_attr_noexcept {
  METASAFE_MALLOC = true;
  void* ptr = mi_heap_malloc_small(mi_prim_get_default_heap(), size);
  METASAFE_MALLOC = false;
  return ptr;
}
...
mi_decl_nodiscard extern inline mi_decl_restrict void* mi_malloc(size_t size) mi_attr_noexcept {
  METASAFE_MALLOC = true;
  void* ptr = mi_heap_malloc(mi_prim_get_default_heap(), size);
  METASAFE_MALLOC = false;
  return ptr;
}
...
mi_decl_nodiscard mi_decl_restrict void* mi_zalloc_small(size_t size) mi_attr_noexcept {
  METASAFE_MALLOC = true;
  void* ptr = mi_heap_malloc_small_zero(mi_prim_get_default_heap(), size, true);
  METASAFE_MALLOC = false;
  return ptr;
}
...
mi_decl_nodiscard mi_decl_restrict void* mi_zalloc(size_t size) mi_attr_noexcept {
  METASAFE_MALLOC = true;
  void* ptr = mi_heap_zalloc(mi_prim_get_default_heap(),size);
  METASAFE_MALLOC = false;
  return ptr;
}
