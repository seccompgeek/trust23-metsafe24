...
//mi_decl_export mi_decl_thread uint64_t METASAFE_TYPE_ID = 0; //defined by Rust?
...
void mi_process_init(void) mi_attr_noexcept {
  ...
  /*iyb start modification*/
  /* void* start_address = mmap((void*)MAGIC_NUMBER, 0x10000000*10, PROT_NONE, MAP_FIXED| MAP_PRIVATE | MAP_ANONYMOUS, -1, 0); */
  /*end of modification*/
}
